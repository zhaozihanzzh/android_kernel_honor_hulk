...
#define CLK_EN_CFG_REG         (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x2F0) /*  ±÷” πƒ‹≈‰÷√ºƒ¥Ê∆˜°£ */
...
#define CLK_EDGE_CFG_REG       (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x2F1) /*  ˝ƒ£Ω”ø⁄ ±÷”—ÿ—°‘Ò°£ */
...
#define SIF_LOOPBACK_CFG_REG   (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x2F2) /* SIFΩ”ø⁄ª∑ªÿøÿ÷∆°£ */
#define ADC_LOOPBACK_LEN    2
#define ADC_LOOPBACK_OFFSET 2
#define DAC_LOOPBACK_LEN    2
#define DAC_LOOPBACK_OFFSET 0

#define DAC_CHAN_CTRL_REG      (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x2F3) /* DACÕ®¬∑≈‰÷√°£ */
...
#define ADC_CHAN_CTRL_REG      (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x2F4) /* ADCÕ®¬∑≈‰÷√°£ */
...
#define ANA_IRQ_SIG_STAT_REG   (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x2F5) /* ƒ£ƒ‚÷–∂œ‘≠ º◊¥Ã¨ºƒ¥Ê∆˜°£ */
...
#define ANA_IRQM_REG0_REG      (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x2F6) /* ANA_IRQ_REG÷–∂œ∆¡±Œºƒ¥Ê∆˜°£ */
...
#define ANA_IRQ_REG0_REG       (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x2F7) /* ƒ£ƒ‚÷–∂œºƒ¥Ê∆˜°£0£¨–¥1«Â£¨∂¡…œ±®÷–∂œ–≈œ¢°£ */
...
#define DEB_CNT_HS_DET_CFG_REG (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x2F8) /* hs_det_irq»•∂∂≈‰÷√°£ */
...
#define DEB_CNT_HS_MIC_CFG_REG (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x2F9) /* hs_mic_irq»•∂∂≈‰÷√°£ */
...
#define CODEC_ANA_RW1_REG      (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x2FA) /* vref/ctcm/ibiasƒ£øÈ πƒ‹°£ */
#define IBIAS_PD_LEN      1
#define IBIAS_PD_OFFSET   2
#define AVREF_SEL_LEN     2
#define AVREF_SEL_OFFSET  0

#define CODEC_ANA_RW2_REG      (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x2FB) /* micpga πƒ‹°£ */
...
#define CODEC_ANA_RW3_REG      (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x2FC) /* adc πƒ‹°£ */
...
#define CODEC_ANA_RW4_REG      (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x2FD) /* dac πƒ‹°£ */
...
#define CODEC_ANA_RW5_REG      (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x2FE) /* headphone πƒ‹°£ */
...
#define CODEC_ANA_RW6_REG      (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x2FF) /* earphone/lineout πƒ‹°£ */
...
#define CODEC_ANA_RW7_REG      (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x300) /* micbias πƒ‹°£ */
...
#define CODEC_ANA_RW8_REG      (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x301) /* mbhd πƒ‹°£ */
...
#define CODEC_ANA_RW9_REG      (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x302) /* mainpga≈‰÷√°£ */
...
#define CODEC_ANA_RW10_REG     (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x303) /* auxpga≈‰÷√°£ */
...
#define CODEC_ANA_RW11_REG     (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x304) /* mic3pga≈‰÷√°£ */
...
#define CODEC_ANA_RW12_REG     (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x305) /* adcl≈‰÷√°£ */
...
#define CODEC_ANA_RW13_REG     (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x306) /* adcl≈‰÷√°£ */
...
#define CODEC_ANA_RW14_REG     (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x307) /* adcr≈‰÷√°£ */
...
#define CODEC_ANA_RW15_REG     (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x308) /* adcr≈‰÷√°£ */
...
#define CODEC_ANA_RW16_REG     (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x309) /* adc3≈‰÷√°£ */
...
#define CODEC_ANA_RW17_REG     (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x30A) /* adc3≈‰÷√°£ */
...
#define CODEC_ANA_RW18_REG     (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x30B) /* dac≈‰÷√°£ */
...
#define CODEC_ANA_RW19_REG     (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x30C) /* chargepump≈‰÷√°£ */
...
#define CODEC_ANA_RW20_REG     (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x30D) /* hp mixer ‰»Î—°‘Ò°£ */
...
#define CODEC_ANA_RW21_REG     (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x30E) /* hp‘ˆ“Ê—°‘Ò°£ */
#define HSL_GAIN_LEN    4
#define HSL_GAIN_OFFSET 4
#define HSR_GAIN_LEN    4
#define HSR_GAIN_OFFSET 0

#define CODEC_ANA_RW22_REG     (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x30F) /* hp≈‰÷√°£ */
...
#define CODEC_ANA_RW23_REG     (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x310) /* hp≈‰÷√°£ */
...
#define CODEC_ANA_RW24_REG     (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x311) /* hp pop≈‰÷√°£ */
...
#define CODEC_ANA_RW25_REG     (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x312) /* ep mixer≈‰÷√°£ */
...
#define CODEC_ANA_RW26_REG     (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x313) /* earphone≈‰÷√°£ */
#define EAR_CM_CTRL_LEN    1
#define EAR_CM_CTRL_OFFSET 4
#define EAR_GAIN_LEN       4
#define EAR_GAIN_OFFSET    0

#define CODEC_ANA_RW27_REG     (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x314) /* lineout mixer≈‰÷√°£ */
...
#define CODEC_ANA_RW28_REG     (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x315) /* lineout≈‰÷√°£ */
#define LOUT_VCM_CTRL_LEN    1
#define LOUT_VCM_CTRL_OFFSET 4
#define LOUT_GAIN_LEN        4
#define LOUT_GAIN_OFFSET     0

#define CODEC_ANA_RW29_REG     (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x316) /* himicbias≈‰÷√°£ */
...
#define CODEC_ANA_RW30_REG     (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x317) /* micbias1≈‰÷√°£ */
...
#define CODEC_ANA_RW31_REG     (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x318) /* micbias2≈‰÷√°£ */
...
#define CODEC_ANA_RW32_REG     (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x319) /* ∂˙ª˙≤Â»ÎºÏ≤‚≈‰÷√°£ */
...
#define CODEC_ANA_RW33_REG     (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x31A) /* ∂˙ª˙∞Œ≥ˆpop≈‰÷√°£ */
...
#define CODEC_ANA_RW34_REG     (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x31B) /* mbhd ref≈‰÷√°£ */
...
#define CODEC_ANA_RW35_REG     (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x31C) /* adc/dac ±÷”—È≈‰÷√°£ */
...
#define CODEC_ANA_RW36_REG     (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x31D) /* rxÕ®¬∑chop ±÷”≈‰÷√°£ */
...
#define CODEC_ANA_RW37_REG     (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x31E) /* txÕ®¬∑chop ±÷”≈‰÷√°£ */
...
#define CODEC_ANA_RW38_REG     (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x31F) /* cp/pop ±÷”≈‰÷√°£ */
...
#define CODEC_ANA_RW39_REG     (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x320) /* capless ±÷”≈‰÷√°£ */
...
#define CODEC_ANA_RW40_REG     (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x321) /* ∆´÷√µÁ¡˜≈‰÷√°£ */
...
#define CODEC_ANA_RW41_REG     (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x322) /* CODEC_ANA_RW41∆´÷√µÁ¡˜≈‰÷√°£ */
...
/******************************************************************************/
#define CTRL_REG_CLASSD_CTRL0_REG               (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x17A) /* classdøÿ÷∆ºƒ¥Ê∆˜0°£ */
...
#define CTRL_REG_CLASSD_CTRL1_REG               (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x17B) /* classdøÿ÷∆ºƒ¥Ê∆˜1°£ */
...
#define CTRL_REG_CLASSD_CTRL2_REG               (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x17C) /* classdøÿ÷∆ºƒ¥Ê∆˜2°£ */
...
#define CTRL_REG_CLASSD_CTRL3_REG               (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x17D) /* classdøÿ÷∆ºƒ¥Ê∆˜3°£ */
#define CTRL_REG_CLASSD_RESERVE1_LEN    8
#define CTRL_REG_CLASSD_RESERVE1_OFFSET 0

#define CTRL_REG_PMU_SOFT_RST_REG        (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x17E) /* PMU»Ì∏¥Œªºƒ¥Ê∆˜°£ */
#define CTRL_REG_SOFT_RST_N_LEN    8
#define CTRL_REG_SOFT_RST_N_OFFSET 0

#define CTRL_REG_DIG_IO_DS_CODEC_CFG_REG  (DA_SEPARATE_V3_PMU_CODEC_BASE + 0x21A) /*  ˝◊÷CODEC IO«˝∂Ø≈‰÷√ºƒ¥Ê∆˜ */
