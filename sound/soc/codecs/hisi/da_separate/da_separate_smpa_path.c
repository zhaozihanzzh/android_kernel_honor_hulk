...
{
	snd_soc_component_update_bits(codec, CLASSH_CTRL1_REG,
		BIT(CLASSH_BYPASS_OFFSET), BIT(CLASSH_BYPASS_OFFSET));
	snd_soc_component_update_bits(codec, CLASSH_CTRL1_REG,
		MASK_ON_BIT(DN_CFG_LEN, DN_CFG_OFFSET), 0x1);

	snd_soc_component_write(codec, LUT_REG0_3_REG, LUT_REG_INIT);
	snd_soc_component_write(codec, LUT_REG4_7_REG, LUT_REG_INIT);
	snd_soc_component_write(codec, LUT_REG8_11_REG, LUT_REG_INIT);
	snd_soc_component_write(codec, LUT_REG12_15_REG, LUT_REG_INIT);
	snd_soc_component_write(codec, LUT_REG16_19_REG, LUT_REG_INIT);
	snd_soc_component_write(codec, LUT_REG20_23_REG, LUT_REG_INIT);
	snd_soc_component_write(codec, LUT_REG24_27_REG, LUT_REG_INIT);
	snd_soc_component_write(codec, LUT_REG28_31_REG, LUT_REG_INIT);
	snd_soc_component_write(codec, LUT_REG32_35_REG, LUT_REG_INIT);
	snd_soc_component_write(codec, LUT_REG36_39_REG, LUT_REG_INIT);
	snd_soc_component_write(codec, LUT_REG40_43_REG, LUT_REG_INIT);
	snd_soc_component_write(codec, LUT_REG44_47_REG, LUT_REG_INIT);
	snd_soc_component_write(codec, LUT_REG48_51_REG, LUT_REG_INIT);
	snd_soc_component_write(codec, LUT_REG52_55_REG, LUT_REG_INIT);
	snd_soc_component_write(codec, LUT_REG56_59_REG, LUT_REG_INIT);
	snd_soc_component_write(codec, LUT_REG60_63_REG, LUT_REG_INIT);
	snd_soc_component_write(codec, LUT_REG64_67_REG, LUT_REG_INIT);
}
	...
	struct snd_kcontrol *kcontrol, int event)
{
	...
	switch (event) {
	case SND_SOC_DAPM_POST_PMU:
		snd_soc_component_update_bits(codec, SPA_SDM_CTRL_REG,
	...
	struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_POST_PMU:
		...
		/* ADC SPAI MUX */
		snd_soc_component_update_bits(codec, CODEC_DIN_MUX1_REG,
