...
static int io_trace_count_upload(void)
{
    ...
    ret = ret | imonitor_set_param_integer_v2(obj, V914009000_STROAGE_MANFID_INT, dm_ufs_manfid);
    ret = ret | imonitor_set_param_integer_v2(obj, V914009000_UFS_QUEUE_TAG_ONE_INT, ufs_tag_cnt_one);
    ret = ret | imonitor_set_param_integer_v2(obj, V914009000_UFS_QUEUE_TAG_TWO_INT, ufs_tag_cnt_two);
    ret = ret | imonitor_set_param_integer_v2(obj, V914009000_UFS_QUEUE_TAG_THREE_INT, ufs_tag_cnt_three);
    ret = ret | imonitor_set_param_integer_v2(obj, V914009000_UFS_QUEUE_TAG_FOUR_INT, ufs_tag_cnt_four);
