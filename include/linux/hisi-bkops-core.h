...
extern void hisi_bkops_set_status_info(struct hisi_bkops *bkops,
	u32 bkops_status_max, char **bkops_status_str);
extern int hisi_bkops_enable(struct request_queue *q, struct hisi_bkops *bkops,
	struct dentry *debugfs_parent_dir);
extern int hisi_bkops_add_debugfs(
	struct hisi_bkops *bkops, struct dentry *bkops_root);
