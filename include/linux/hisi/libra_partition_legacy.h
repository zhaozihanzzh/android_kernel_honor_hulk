...
static const struct partition partition_table_emmc[] =
{
  ...
  {PART_RESERVED8,           968*1024,        200*1024,    EMMC_USER_PART},/* reserved8      200M   p67*/
  {PART_SUPER,              1168*1024,       7020*1024,    EMMC_USER_PART},/* super          7020M   p68*/
  {PART_CACHE,              8188*1024,        104*1024,    EMMC_USER_PART},/* cache           104M   p69*/
  {PART_VERSION,            8292*1024,        576*1024,    EMMC_USER_PART},/* version         576M   p70*/
  {PART_PRELOAD,            8868*1024,        900*1024,    EMMC_USER_PART},/* preload         900M   p71*/
  #ifdef CONFIG_FACTORY_MODE
  {PART_HIBENCH_IMG,        9768*1024,        128*1024,    EMMC_USER_PART},/*hibench_img     128M    p72*/
  {PART_HIBENCH_DATA,       9896*1024,        512*1024,    EMMC_USER_PART},/* hibench_data   512M    p73*/
  {PART_FLASH_AGEING,      10408*1024,        512*1024,    EMMC_USER_PART},/* flash_ageing   512M    p74*/
  {PART_HIBENCH_LOG,       10920*1024,         32*1024,    EMMC_USER_PART},/* HIBENCH_LOG    32M     p75*/
  {PART_USERDATA,          10952*1024, (4UL)*1024*1024,    EMMC_USER_PART},/* userdata       4G      p76*/
  #else
  {PART_USERDATA,           9768*1024, (4UL)*1024*1024,    EMMC_USER_PART},/* userdata       4G      p72*/
  #endif
...
static const struct partition partition_table_ufs[] =
{
  ...
  {PART_RESERVED8,           960*1024,         200*1024,    UFS_PART_3},/* reserved8     200M     p63*/
  {PART_SUPER,              1160*1024,        7020*1024,    UFS_PART_3},/* super         7020M    p64*/
  {PART_CACHE,              8180*1024,         104*1024,    UFS_PART_3},/* cache          104M    p65*/
  {PART_VERSION,            8284*1024,         576*1024,    UFS_PART_3},/* version        576M    p66*/
  {PART_PRELOAD,            8860*1024,         900*1024,    UFS_PART_3},/* preload        900M    p67*/
  #ifdef CONFIG_FACTORY_MODE
  {PART_HIBENCH_IMG,        9760*1024,         128*1024,    UFS_PART_3},/* hibench_img    128M    p68*/
  {PART_HIBENCH_DATA,       9888*1024,         512*1024,    UFS_PART_3},/* hibench_data   512M    p69*/
  {PART_FLASH_AGEING,      10400*1024,         512*1024,    UFS_PART_3},/* flash_ageing   512M    p70*/
  {PART_HIBENCH_LOG,       10912*1024,          32*1024,    UFS_PART_3},/* HIBENCH_LOG     32M    p71*/
  {PART_USERDATA,          10944*1024,  (4UL)*1024*1024,    UFS_PART_3},/* userdata         4G    p72*/
  #else
  {PART_USERDATA,           9760*1024,  (4UL)*1024*1024,    UFS_PART_3},/* userdata         4G    p68*/
  #endif
  #endif  /* CONFIG_MARKET_INTERNAL */
#endif  /* CONFIG_NEW_PRODUCT_P */
  {"0", 0, 0, 0},
