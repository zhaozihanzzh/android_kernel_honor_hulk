...
static const struct partition partition_table_emmc[] =
{
  ...
  {PART_PREAS,                     1088*1024,        1216*1024,        EMMC_USER_PART},/* preas           1216M    p62*/
  {PART_PREAVS,                    2304*1024,          32*1024,        EMMC_USER_PART},/* preavs            32M    p63*/
  {PART_VENDOR_A,                  2336*1024,        1232*1024,        EMMC_USER_PART},/* vendor          1232M    p64*/
  {PART_ODM_A,                     3568*1024,         224*1024,        EMMC_USER_PART},/* odm              224M    p65*/
  ...
  {PART_PRODUCT_A,                 7552*1024,        2360*1024,        EMMC_USER_PART},/* product         2360M    p68*/
  {PART_VERSION_A,                 9912*1024,         576*1024,        EMMC_USER_PART},/* version          576M    p69*/
  {PART_PRELOAD_A,                10488*1024,        1144*1024,        EMMC_USER_PART},/* preload_a       1144M    p70*/
  {PART_HIBENCH_IMG,              11632*1024,         128*1024,        EMMC_USER_PART},/* hibench_img      128M    p71*/
  {PART_HIBENCH_DATA,             11760*1024,         512*1024,        EMMC_USER_PART},/* hibench_data     512M    p72*/
  {PART_FLASH_AGEING,             12272*1024,         512*1024,        EMMC_USER_PART},/* FLASH_AGEING     512M    p73*/
  {PART_HIBENCH_LOG,              12784*1024,         32*1024,         EMMC_USER_PART},/* HIBENCH_LOG      32M     p74*/
  {PART_USERDATA,                 12816*1024,  (4UL)*1024*1024,        EMMC_USER_PART},/* userdata           4G    p75*/
#else
#ifdef CONFIG_USE_EROFS
#ifdef CONFIG_MARKET_INTERNAL
  {PART_PREAS,                     1088*1024,         296*1024,        EMMC_USER_PART},/* preas            296M    p62*/
  {PART_PREAVS,                    1384*1024,          32*1024,        EMMC_USER_PART},/* preavs            32M    p63*/
  {PART_VENDOR_A,                  1416*1024,         864*1024,        EMMC_USER_PART},/* vendor           864M    p64*/
  {PART_ODM_A,                     2280*1024,         136*1024,        EMMC_USER_PART},/* odm              136M    p65*/
  {PART_CUST_A,                    2416*1024,          88*1024,        EMMC_USER_PART},/* cust              88M    p66*/
  {PART_SYSTEM_A,                  2504*1024,        2544*1024,        EMMC_USER_PART},/* system          2544M    p67*/
  {PART_PRODUCT_A,                 5048*1024,        2000*1024,        EMMC_USER_PART},/* product         2000M    p68*/
  {PART_VERSION_A,                 7048*1024,         576*1024,        EMMC_USER_PART},/* version          576M    p69*/
  {PART_PRELOAD_A,                 7624*1024,        1144*1024,        EMMC_USER_PART},/* preload_a       1144M    p70*/
  {PART_USERDATA,                  8768*1024,  (4UL)*1024*1024,        EMMC_USER_PART},/* userdata           4G    p71*/
#else
  {PART_PREAS,                     1088*1024,         976*1024,        EMMC_USER_PART},/* preas            976M    p62*/
  {PART_PREAVS,                    2064*1024,          32*1024,        EMMC_USER_PART},/* preavs            32M    p63*/
  {PART_VENDOR_A,                  2096*1024,         864*1024,        EMMC_USER_PART},/* vendor           864M    p64*/
  {PART_ODM_A,                     2960*1024,         136*1024,        EMMC_USER_PART},/* odm              136M    p65*/
  {PART_CUST_A,                    3096*1024,          88*1024,        EMMC_USER_PART},/* cust              88M    p66*/
  {PART_SYSTEM_A,                  3184*1024,        2312*1024,        EMMC_USER_PART},/* system          2312M    p67*/
  {PART_PRODUCT_A,                 5496*1024,        2152*1024,        EMMC_USER_PART},/* product         2152M    p68*/
  {PART_VERSION_A,                 7648*1024,         576*1024,        EMMC_USER_PART},/* version          576M    p69*/
  {PART_PRELOAD_A,                 8224*1024,        1144*1024,        EMMC_USER_PART},/* preload_a       1144M    p70*/
  {PART_USERDATA,                  9368*1024,  (4UL)*1024*1024,        EMMC_USER_PART},/* userdata           4G    p71*/
#endif
#else
#ifdef CONFIG_MARKET_INTERNAL
  {PART_PREAS,                     1088*1024,         360*1024,        EMMC_USER_PART},/* preas            360M    p62*/
  {PART_PREAVS,                    1448*1024,          32*1024,        EMMC_USER_PART},/* preavs            32M    p63*/
  {PART_VENDOR_A,                  1480*1024,        1232*1024,        EMMC_USER_PART},/* vendor          1232M    p64*/
  {PART_ODM_A,                     2712*1024,         192*1024,        EMMC_USER_PART},/* odm              192M    p65*/
  {PART_CUST_A,                    2904*1024,         192*1024,        EMMC_USER_PART},/* cust             192M    p66*/
  {PART_SYSTEM_A,                  3096*1024,        3760*1024,        EMMC_USER_PART},/* system          3760M    p67*/
  {PART_PRODUCT_A,                 6856*1024,        2104*1024,        EMMC_USER_PART},/* product         2104M    p68*/
  {PART_VERSION_A,                 8960*1024,         576*1024,        EMMC_USER_PART},/* version          576M    p69*/
  {PART_PRELOAD_A,                 9536*1024,        1144*1024,        EMMC_USER_PART},/* preload_a       1144M    p70*/
  {PART_USERDATA,                 10680*1024,  (4UL)*1024*1024,        EMMC_USER_PART},/* userdata           4G    p71*/
#else
  {PART_PREAS,                     1088*1024,        1216*1024,        EMMC_USER_PART},/* preas           1216M    p62*/
  {PART_PREAVS,                    2304*1024,          32*1024,        EMMC_USER_PART},/* preavs            32M    p63*/
  {PART_VENDOR_A,                  2336*1024,        1232*1024,        EMMC_USER_PART},/* vendor          1232M    p64*/
  {PART_ODM_A,                     3568*1024,         192*1024,        EMMC_USER_PART},/* odm              192M    p65*/
  {PART_CUST_A,                    3760*1024,         192*1024,        EMMC_USER_PART},/* cust             192M    p66*/
  {PART_SYSTEM_A,                  3952*1024,        3568*1024,        EMMC_USER_PART},/* system          3568M    p67*/
  {PART_PRODUCT_A,                 7520*1024,        2360*1024,        EMMC_USER_PART},/* product         2360M    p68*/
  {PART_VERSION_A,                 9880*1024,         576*1024,        EMMC_USER_PART},/* version          576M    p69*/
  {PART_PRELOAD_A,                10456*1024,        1144*1024,        EMMC_USER_PART},/* preload_a       1144M    p70*/
  {PART_USERDATA,                 11600*1024,  (4UL)*1024*1024,        EMMC_USER_PART},/* userdata           4G    p71*/
#endif
#endif
#endif
...
#ifdef CONFIG_FACTORY_MODE
  {PART_PREAS,                     1080*1024,        1216*1024,        UFS_PART_3},/* preas                1216M    p58*/
  {PART_PREAVS,                    2296*1024,          32*1024,        UFS_PART_3},/* preavs                 32M    p59*/
  {PART_VENDOR_A,                  2328*1024,        1232*1024,        UFS_PART_3},/* vendor               1232M    p60*/
  {PART_ODM_A,                     3560*1024,         224*1024,        UFS_PART_3},/* odm                   224M    p61*/
  {PART_CUST_A,                    3784*1024,         192*1024,        UFS_PART_3},/* cust                  192M    p62*/
  {PART_SYSTEM_A,                  3976*1024,        3568*1024,        UFS_PART_3},/* system               3568M    p63*/
  {PART_PRODUCT_A,                 7544*1024,        2360*1024,        UFS_PART_3},/* product              2360M    p64*/
  {PART_VERSION_A,                 9904*1024,         576*1024,        UFS_PART_3},/* version               576M    p65*/
  {PART_PRELOAD_A,                10480*1024,        1144*1024,        UFS_PART_3},/* preload_a            1144M    p66*/
  {PART_HIBENCH_IMG,              11624*1024,         128*1024,        UFS_PART_3},/* hibench_img           128M    p67*/
  {PART_HIBENCH_DATA,             11752*1024,         512*1024,        UFS_PART_3},/* hibench_data          512M    p68*/
  {PART_FLASH_AGEING,             12264*1024,         512*1024,        UFS_PART_3},/* FLASH_AGEING          512M    p69*/
  {PART_HIBENCH_LOG,              12776*1024,          32*1024,        UFS_PART_3},/* HIBENCH_LOG           32M     p70*/
  {PART_USERDATA,                 12808*1024,  (4UL)*1024*1024,        UFS_PART_3},/* userdata                4G    p71*/
#else
#ifdef CONFIG_USE_EROFS
#ifdef CONFIG_MARKET_INTERNAL
  {PART_PREAS,                     1080*1024,         296*1024,        UFS_PART_3},/* preas                 296M    p58*/
  {PART_PREAVS,                    1376*1024,          32*1024,        UFS_PART_3},/* preavs                 32M    p59*/
  {PART_VENDOR_A,                  1408*1024,         864*1024,        UFS_PART_3},/* vendor                864M    p60*/
  {PART_ODM_A,                     2272*1024,         136*1024,        UFS_PART_3},/* odm                   136M    p61*/
  {PART_CUST_A,                    2408*1024,          88*1024,        UFS_PART_3},/* cust                   88M    p62*/
  {PART_SYSTEM_A,                  2496*1024,        2544*1024,        UFS_PART_3},/* system               2544M    p63*/
  {PART_PRODUCT_A,                 5040*1024,        2000*1024,        UFS_PART_3},/* product              2000M    p64*/
  {PART_VERSION_A,                 7040*1024,         576*1024,        UFS_PART_3},/* version               576M    p65*/
  {PART_PRELOAD_A,                 7616*1024,        1144*1024,        UFS_PART_3},/* preload_a            1144M    p66*/
  {PART_USERDATA,                  8760*1024,  (4UL)*1024*1024,        UFS_PART_3},/* userdata                4G    p67*/
#else
  {PART_PREAS,                     1080*1024,         976*1024,        UFS_PART_3},/* preas                 976M    p58*/
  {PART_PREAVS,                    2056*1024,          32*1024,        UFS_PART_3},/* preavs                 32M    p59*/
  {PART_VENDOR_A,                  2088*1024,         864*1024,        UFS_PART_3},/* vendor                864M    p60*/
  {PART_ODM_A,                     2952*1024,         136*1024,        UFS_PART_3},/* odm                   136M    p61*/
  {PART_CUST_A,                    3088*1024,          88*1024,        UFS_PART_3},/* cust                   88M    p62*/
  {PART_SYSTEM_A,                  3176*1024,        2312*1024,        UFS_PART_3},/* system               2312M    p63*/
  {PART_PRODUCT_A,                 5488*1024,        2152*1024,        UFS_PART_3},/* product              2152M    p64*/
  {PART_VERSION_A,                 7640*1024,         576*1024,        UFS_PART_3},/* version               576M    p65*/
  {PART_PRELOAD_A,                 8216*1024,        1144*1024,        UFS_PART_3},/* preload_a            1144M    p66*/
  {PART_USERDATA,                  9360*1024,  (4UL)*1024*1024,        UFS_PART_3},/* userdata                4G    p67*/
#endif
#else
#ifdef CONFIG_MARKET_INTERNAL
  {PART_PREAS,                     1080*1024,         360*1024,        UFS_PART_3},/* preas                 360M    p58*/
  {PART_PREAVS,                    1440*1024,          32*1024,        UFS_PART_3},/* preavs                 32M    p59*/
  {PART_VENDOR_A,                  1472*1024,        1232*1024,        UFS_PART_3},/* vendor               1232M    p60*/
  {PART_ODM_A,                     2704*1024,         192*1024,        UFS_PART_3},/* odm                   192M    p61*/
  {PART_CUST_A,                    2896*1024,         192*1024,        UFS_PART_3},/* cust                  192M    p62*/
  {PART_SYSTEM_A,                  3088*1024,        3760*1024,        UFS_PART_3},/* system               3760M    p63*/
  {PART_PRODUCT_A,                 6848*1024,        2104*1024,        UFS_PART_3},/* product              2104M    p64*/
  {PART_VERSION_A,                 8952*1024,         576*1024,        UFS_PART_3},/* version               576M    p65*/
  {PART_PRELOAD_A,                 9528*1024,        1144*1024,        UFS_PART_3},/* preload_a            1144M    p66*/
  {PART_USERDATA,                 10672*1024,  (4UL)*1024*1024,        UFS_PART_3},/* userdata                4G    p67*/
#else
  {PART_PREAS,                     1080*1024,        1216*1024,        UFS_PART_3},/* preas                1216M    p58*/
  {PART_PREAVS,                    2296*1024,          32*1024,        UFS_PART_3},/* preavs                 32M    p59*/
  {PART_VENDOR_A,                  2328*1024,        1232*1024,        UFS_PART_3},/* vendor               1232M    p60*/
  {PART_ODM_A,                     3560*1024,         192*1024,        UFS_PART_3},/* odm                   192M    p61*/
  {PART_CUST_A,                    3752*1024,         192*1024,        UFS_PART_3},/* cust                  192M    p62*/
  {PART_SYSTEM_A,                  3944*1024,        3568*1024,        UFS_PART_3},/* system               3568M    p63*/
  {PART_PRODUCT_A,                 7512*1024,        2360*1024,        UFS_PART_3},/* product              2360M    p64*/
  {PART_VERSION_A,                 9872*1024,         576*1024,        UFS_PART_3},/* version               576M    p65*/
  {PART_PRELOAD_A,                10448*1024,        1144*1024,        UFS_PART_3},/* preload_a            1144M    p66*/
  {PART_USERDATA,                 11592*1024,  (4UL)*1024*1024,        UFS_PART_3},/* userdata                4G    p67*/
#endif
#endif
#endif
  {"0", 0, 0, 0},
