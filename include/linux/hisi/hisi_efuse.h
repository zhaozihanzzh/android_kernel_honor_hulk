...
extern s32 hisi_efuse_read_value(uint32_t *buf, u32 buf_size, u32 func_id);
extern s32 hisi_efuse_write_value(uint32_t *buf, u32 buf_size, u32 func_id);
...
static inline s32 hisi_efuse_read_value(uint32_t *buf, u32 buf_size, u32 func_id)
{
	return OK;
}
static inline s32 hisi_efuse_write_value(uint32_t *buf, u32 buf_size, u32 func_id)
{
	return OK;
}
#endif
