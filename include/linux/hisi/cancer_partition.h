...
static const struct partition partition_table_emmc[] =
{
  ...
  {PART_ODM_A,                     3408*1024,         224*1024,        EMMC_USER_PART},/* odm              224M    p65*/
  {PART_CUST_A,                    3632*1024,         192*1024,        EMMC_USER_PART},/* cust             192M    p66*/
  {PART_SYSTEM_A,                  3824*1024,        3568*1024,        EMMC_USER_PART},/* system          3568M    p67*/
  {PART_PRODUCT_A,                 7392*1024,        2360*1024,        EMMC_USER_PART},/* product         2360M    p68*/
  {PART_VERSION_A,                 9752*1024,         576*1024,        EMMC_USER_PART},/* version          576M    p69*/
  {PART_PRELOAD_A,                10328*1024,        1144*1024,        EMMC_USER_PART},/* preload_a       1144M    p70*/
  {PART_HIBENCH_IMG,              11472*1024,         128*1024,        EMMC_USER_PART},/* hibench_img      128M    p71*/
  {PART_HIBENCH_DATA,             11600*1024,         512*1024,        EMMC_USER_PART},/* hibench_data     512M    p72*/
  {PART_FLASH_AGEING,             12112*1024,         512*1024,        EMMC_USER_PART},/* FLASH_AGEING     512M    p73*/
  {PART_HIBENCH_LOG,              12624*1024,          32*1024,        EMMC_USER_PART},/* HIBENCH_LOG       32M    p74*/
  {PART_USERDATA,                 12656*1024,  (4UL)*1024*1024,        EMMC_USER_PART},/* userdata           4G    p75*/
#else
...
static const struct partition partition_table_ufs[] =
{
  ...
  {PART_ODM_A,                         3400*1024,         224*1024,        UFS_PART_3},/* odm                   224M    p61*/
  {PART_CUST_A,                        3624*1024,         192*1024,        UFS_PART_3},/* cust                  192M    p62*/
  {PART_SYSTEM_A,                      3816*1024,        3568*1024,        UFS_PART_3},/* system               3568M    p63*/
  {PART_PRODUCT_A,                     7384*1024,        2360*1024,        UFS_PART_3},/* product              2360M    p64*/
  {PART_VERSION_A,                     9744*1024,         576*1024,        UFS_PART_3},/* version               576M    p65*/
  {PART_PRELOAD_A,                    10320*1024,        1144*1024,        UFS_PART_3},/* preload_a            1144M    p66*/
  {PART_HIBENCH_IMG,                  11464*1024,         128*1024,        UFS_PART_3},/* hibench_img           128M    p67*/
  {PART_HIBENCH_DATA,                 11592*1024,         512*1024,        UFS_PART_3},/* hibench_data          512M    p68*/
  {PART_FLASH_AGEING,                 12104*1024,         512*1024,        UFS_PART_3},/* FLASH_AGEING          512M    p69*/
  {PART_HIBENCH_LOG,                  12616*1024,          32*1024,        UFS_PART_3},/* HIBENCH_LOG           32M     p70*/
  {PART_USERDATA,                     12648*1024,  (4UL)*1024*1024,        UFS_PART_3},/* userdata              4G      p71*/
#else
#ifdef CONFIG_USE_EROFS
#ifdef CONFIG_MARKET_INTERNAL
  ...
  {PART_PRELOAD_A,                     9368*1024,        1144*1024,        UFS_PART_3},/* preload_a            1144M    p66*/
  ...
  {PART_PRELOAD_A,                    10288*1024,        1144*1024,        UFS_PART_3},/* preload_a            1144M    p66*/
