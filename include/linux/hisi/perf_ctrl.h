...
#define PERF_CTRL_SET_VIP_PRIO _IOW(PERF_CTRL_MAGIC, SET_VIP_PRIO, struct task_config)
#define PERF_CTRL_SET_FAVOR_SMALL_CAP _IOW(PERF_CTRL_MAGIC, SET_FAVOR_SMALL_CAP, struct task_config)
