...
static const struct partition partition_table_emmc[] =
{
  ...
  {PART_HIBENCH_LOG,             12658*1024,        32*1024,     EMMC_USER_PART},/* HIBENCH_LOG      32M     p74*/
  {PART_USERDATA,                12690*1024, (4UL)*1024*1024,    EMMC_USER_PART},/* userdata           4G    p75*/
  #else
  {PART_USERDATA,                11506*1024, (4UL)*1024*1024,    EMMC_USER_PART},/* userdata           4G    p71*/
  #endif
  #endif
...
static const struct partition partition_table_ufs[] =
{
  ...
  {PART_HIBENCH_LOG,              12650*1024,        32*1024,     UFS_PART_3},/* HIBENCH_LOG       32M    p70*/
  {PART_USERDATA,                 12682*1024, (4UL)*1024*1024,    UFS_PART_3},/* userdata            4G   p71*/
  #else
  {PART_USERDATA,                 11498*1024, (4UL)*1024*1024,    UFS_PART_3},/* userdata            4G   p67*/
  #endif
  #endif
