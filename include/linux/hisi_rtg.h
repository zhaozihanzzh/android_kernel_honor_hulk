...
int sched_set_group_load_mode(unsigned int grp_id, bool freq_enabled, bool util_enabled);
...
static inline int sched_set_group_load_mode(unsigned int grp_id, bool freq_enabled, bool util_enabled) { return 0; }
#endif
