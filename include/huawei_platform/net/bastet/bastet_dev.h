...
#define BST_IOC_SOCK_SYNC_STOP		_IOW(BST_IOC_MAGIC, 2, \
	struct bst_sock_id)
...
#define BST_IOC_SOCK_CLOSE_SET		_IOW(BST_IOC_MAGIC, 5, \
	struct bst_sock_comm_prop)
#define BST_IOC_SOCK_STATE_GET		_IOWR(BST_IOC_MAGIC, 6, \
	struct bst_get_bastet_sock_state)
#define BST_IOC_APPLY_LOCAL_PORT	_IOR(BST_IOC_MAGIC, 7, \
	uint16_t)
#define BST_IOC_RELEASE_LOCAL_PORT	_IOW(BST_IOC_MAGIC, 8, \
	uint16_t)
...
#define BST_IOC_SOCK_SYNC_PREPARE	_IOW(BST_IOC_MAGIC, 21, \
	struct bst_set_sock_sync_delay)
#define BST_IOC_GET_FD_BY_ADDR		_IOWR(BST_IOC_MAGIC, 22, \
	struct addr_to_fd)
#define BST_IOC_GET_CMDLINE		_IOWR(BST_IOC_MAGIC, 23, \
	struct get_cmdline)
...
#define BST_IOC_FAST_GRAB_INFO		_IOW(BST_IOC_MAGIC, 28, \
	struct fastgrab_info)
#define BST_IOC_SET_PROC_INFO		_IOWR(BST_IOC_MAGIC, 29, \
...
#define BST_IOC_SEND_HB_DATA		_IOW(BST_IOC_MAGIC, 33, \
	struct heartbeat_content)
#define BST_IOC_SET_HB_REPLY		_IOW(BST_IOC_MAGIC, 34, \
	struct heartbeat_content)
#define BST_IOC_FILTER_HB_REPLY		_IOW(BST_IOC_MAGIC, 35, \
	struct bst_sock_id)
#define BST_IOC_SET_FREEZER_STATE	_IOW(BST_IOC_MAGIC, 36, \
