...
#define RX_AVG_IOUT_TIME            10000 /* 10 * 1000 */
...
extern void wireless_charger_pmic_vbus_handler(bool vbus_state);

extern void wireless_charge_chip_init(int tx_vset);
extern int wireless_charge_set_tx_vout(int tx_vout);
extern int wireless_charge_set_rx_vout(int rx_vout);
...
extern bool wireless_charge_mode_judge_criterion(int pmode_index,
	int crit_type);
