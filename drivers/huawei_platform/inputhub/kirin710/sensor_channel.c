...
static void get_psensor_calibrate_data(void)
{
	...
	if (ps_first_start_flag == 0 &&  (txc_ps_flag == 1 || ams_tmd2620_ps_flag == 1 ||
		avago_apds9110_ps_flag == 1 || ams_tmd3725_ps_flag == 1 || liteon_ltr582_ps_flag == 1 ||
		apds9999_ps_flag == 1 || ams_tmd3702_ps_flag == 1 || vishay_vcnl36658_ps_flag == 1 ||
		ltr2568_ps_flag == 1 || ps_external_ir_calibrate_flag == 1)) {
