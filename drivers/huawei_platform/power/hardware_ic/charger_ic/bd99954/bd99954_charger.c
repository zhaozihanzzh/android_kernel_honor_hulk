...
static int bd99954_5v_chip_init(struct bd99954_device_info *di)
{
	...
	/* fast charge watchdog 12h, pre-charge timer 2h */
	ret |= bd99954_write_word(BD99954_REG_CHGWDT_SET, 0xB478);
	/* vbat ovp 9488mv */
...
static int bd99954_set_terminal_voltage(int value)
{
	...
	(void)bd99954_read_word(BD99954_REG_CHGOP_SET2, &reg_0c);
	if ((reg_0c & BD99954_REG_CHG_EN_MASK) == 0) {
		hwlog_info("no charging, vterm unchanged\n");
		voltagemv = di->vterm;
	}
