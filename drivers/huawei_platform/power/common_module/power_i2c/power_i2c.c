...
static int power_i2c_write_block(struct i2c_client *client, u8 *buf, u8 buf_len)
{
...
static int power_i2c_read_block(struct i2c_client *client, u8 *cmd, u8 cmd_len,
	u8 *buf, u8 buf_len)
{
...
int power_i2c_u8_read_word(struct i2c_client *client, u8 reg, u16 *data)
{
	...
	/* buf[0]: low-8bit data, buf[1]: high-8bit data */
	*data = (buf[0] | (buf[1] << 8));
	return 0;
}
