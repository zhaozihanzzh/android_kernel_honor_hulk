...
#define ADDR_LEN 36
	...
	if (gether_set_dev_addr(opts->net, dev_addr)) {
		pr_info("failed gether_set_dev_addr()\n");
	}

	if (gether_set_host_addr(opts->net, host_addr)) {
		pr_info("failed gether_set_host_addr()\n");
	}
