 ...
 * Description: Header file for hisi vbat drop protect device driver
 * Author: Hisilicon
 * Create: 2019-11-21
 */
...
#define BIG_VOL_DROP_EN_ADDR(base)					\
	SOC_CORECRG_B_M_VS_SVFD_CTRL2_BIG0_ADDR(base)
#define L3_VOL_DROP_EN_ADDR(base)					\
	SOC_CORECRG_L_L3_VS_SVFD_CTRL2_L3_ADDR(base)
#define GPU_VOL_DROP_EN_ADDR(base)					\
	SOC_PMCTRL_VS_SVFD_CTRL2_GPU_ADDR(base)
#define NPU_VOL_DROP_EN_ADDR(base)					\
	SOC_NPUCRG_VS_SVFD_CTRL2_NPU_ADDR(base)
...
#define GPU_VOL_DROP_EN_STAT_ADDR(base)					\
	SOC_PMCTRL_VS_TEST_STAT_GPU_ADDR(base)
