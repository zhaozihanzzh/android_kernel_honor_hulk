...
#if defined(CONFIG_SH_AOD_ENABLE) && !defined(CONFIG_HISI_FB_970) || defined(CONFIG_HISI_FB_V350)
...
void hisifb_masklayer_backlight_notify_handler(struct work_struct *work)
{
	...
	if ((hisifd->index == PRIMARY_PANEL_IDX) && ((g_dss_version_tag == FB_ACCEL_DSSV501)
		|| (g_dss_version_tag == FB_ACCEL_DSSV330) || (g_dss_version_tag == FB_ACCEL_DSSV320) || \
			(g_dss_version_tag == FB_ACCEL_DSSV510) || (g_dss_version_tag == FB_ACCEL_DSSV350))) {
