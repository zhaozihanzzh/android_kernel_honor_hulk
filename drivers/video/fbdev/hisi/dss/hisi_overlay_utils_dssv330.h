...
#define DEFAULT_PCLK_PCTRL_RATE	(80000000UL)  // CONFIG_PCLK_PCTRL_USED ??  mabe no use
//#define DSS_MAX_PXL0_CLK_288M (288000000UL)  //no use
...
#define DEFAULT_DSS_CORE_CLK_RATE_L1	(232000000UL)  //(231720000UL)
...
/*pix1_clk: orlando not have PXL1 */
//#define DEFAULT_DSS_PXL1_CLK_RATE_L3	(231000000UL) //no use v330
//#define DEFAULT_DSS_PXL1_CLK_RATE_L2	(231000000UL) //no use v330
//#define DEFAULT_DSS_PXL1_CLK_RATE_L1	(231000000UL) //no use v330
...
#define HISIFB_DSS_PLATFORM_TYPE  (FB_ACCEL_DSSV330 | FB_ACCEL_PLATFORM_TYPE_ASIC)
