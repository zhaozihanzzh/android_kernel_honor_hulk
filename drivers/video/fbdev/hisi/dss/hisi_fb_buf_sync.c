	...
	int32_t *release_fence_fd, int32_t *retire_fence_fd)
{
	...
	if (g_debug_fence_timeline) {
		HISI_FB_INFO("hisifb%d frame_no(%d) create fence timeline_max(%d), %s(%d),"
			"%s(%d), timeline(%d), timeline_retire(%d), release_fence_fd(%d), retire_fence_fd(%d)!\n",
...
int hisifb_buf_sync_create_fence(struct hisi_fb_data_type *hisifd, int32_t *release_fence_fd, int32_t *retire_fence_fd)
{
	...
	*retire_fence_fd = retire_fence_fd;
