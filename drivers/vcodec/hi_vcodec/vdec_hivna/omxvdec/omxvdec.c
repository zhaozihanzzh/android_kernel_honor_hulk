...
static long omxvdec_ioctl_common(struct file *file, unsigned int cmd, unsigned long arg, COMPAT_TYPE_E type)
{
	...
	case VDEC_IOCTL_VDM_PROC:
		...
		CHECK_RETURN(vdec_msg.in != HI_NULL, "VDEC_IOCTL_VDM_PROC, invalid input prarameter");
		CHECK_RETURN(vdec_msg.out != HI_NULL, "VDEC_IOCTL_VDM_PROC, invalid output prarameter");
	...
	case VDEC_IOCTL_GET_VDM_HWSTATE:
		CHECK_RETURN(vdec_msg.out != HI_NULL, "VDEC_IOCTL_GET_VDM_HWSTATE, invalid output prarameter");
	...
	case VDEC_IOCTL_SCD_PROC:
		CHECK_RETURN(vdec_msg.in != HI_NULL, "VDEC_IOCTL_SCD_PROC, invalid input prarameter");
		CHECK_RETURN(vdec_msg.out != HI_NULL, "VDEC_IOCTL_SCD_PROC, invalid output prarameter");
	...
	case VDEC_IOCTL_IOMMU_MAP:
		CHECK_RETURN(vdec_msg.in != HI_NULL, "VDEC_IOCTL_IOMMU_MAP, invalid input prarameter");
		CHECK_RETURN(vdec_msg.out != HI_NULL, "VDEC_IOCTL_IOMMU_MAP, invalid output prarameter");
...
static long omxvdec_compat_ioctl(struct file *file, unsigned int cmd, unsigned long arg)
{
	...
	return  omxvdec_ioctl_common(file, cmd, (unsigned long)(uintptr_t)user_ptr, T_IOCTL_ARG_COMPAT);
}
#endif
...
OMXVDEC_ENTRY omxvdec_getEntry(HI_VOID)
{
	return g_OmxVdecEntry;
}
