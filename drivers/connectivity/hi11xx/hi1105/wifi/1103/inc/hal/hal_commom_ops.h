...
#ifdef _PRE_WLAN_FEATURE_HIEX
extern oal_void hi1105_set_himit_ctrl(hal_to_dmac_device_stru *pst_hal_device,
                                      oal_uint8 uc_cfg_ht_htc_psr_himit_en,
                                      oal_uint8 uc_cfg_vht_htc_psr_himit_en,
                                      oal_uint8 uc_cfg_he_htc_psr_himit_en,
                                      oal_uint8 uc_he_htc_himit_id);
extern oal_void hi1105_set_himit_info_report_reg(hal_to_dmac_device_stru *pst_hal_device,
