...
/* 3 枚举定义 */
/* 4 全局变量声明 */
typedef oal_void (*opmode_field)(mac_vap_stru *pst_mac_vap, mac_user_stru *pst_mac_user,
                                 mac_opmode_notify_stru *pst_opmode_notify);

typedef oal_void (*vht_opern)(mac_vap_stru *pst_mac_vap, oal_uint8 *puc_payload,
                              mac_user_stru *pst_mac_user, oal_uint8 *pst_ch);
typedef oal_void (*ht_opern)(mac_vap_stru *pst_mac_vap, oal_uint8 *puc_payload,
                             mac_user_stru *pst_mac_user, oal_uint32 *pst_ch);
...
/* 8 UNION定义 */
/* 9 OTHERS定义 */
extern oal_void mac_proc_ht_opern_ie_cb(mac_vap_stru *pst_mac_vap, oal_uint8 *puc_payload,
                                        mac_user_stru *pst_mac_user, oal_uint32 *pst_ch);
...
OAL_STATIC OAL_INLINE wlan_channel_bandwidth_enum_uint8 mac_get_bandwith_from_center_freq_seg0(
    oal_uint8 uc_chan_width, oal_uint8 uc_channel, oal_uint8 uc_chan_center_freq)
{
    /* 80+80不支持，暂按80M处理 */
...
OAL_STATIC OAL_INLINE oal_uint8 mac_get_bandwith_from_center_freq_seg0_seg1(
    oal_uint8 uc_chan_width, oal_uint8 uc_channel, oal_uint8 uc_chan_center_freq0, oal_uint8 uc_chan_center_freq1)
{
    /* 80+80不支持，暂按80M处理 */
    if (uc_chan_width & WLAN_MIB_VHT_OP_WIDTH_80) {
#ifdef _PRE_WLAN_FEATURE_160M
...
#endif
extern wlan_mib_mimo_power_save_enum_uint8 mac_ie_proc_sm_power_save_field_etc(
    mac_user_stru *pst_mac_user, oal_uint8 uc_smps);

extern oal_bool_enum_uint8 mac_ie_proc_ht_green_field_etc(mac_user_stru *pst_mac_user_sta,
                                                          mac_vap_stru *pst_mac_vap,
                                                          oal_uint8 uc_ht_green_field,
                                                          oal_bool_enum en_prev_asoc_ht);

extern oal_bool_enum_uint8 mac_ie_proc_ht_supported_channel_width_etc(mac_user_stru *pst_mac_user_sta,
                                                                      mac_vap_stru *pst_mac_vap,
                                                                      oal_uint8 uc_supported_channel_width,
                                                                      oal_bool_enum en_prev_asoc_ht);

extern oal_bool_enum_uint8 mac_ie_proc_lsig_txop_protection_support_etc(mac_user_stru *pst_mac_user_sta,
                                                                        mac_vap_stru *pst_mac_vap,
...
extern oal_uint8 mac_ie_get_chan_num_etc(oal_uint8 *puc_frame_body,
                                         oal_uint16 us_frame_len,
                                         oal_uint16 us_offset,
                                         oal_uint8 us_curr_chan);

extern oal_uint32 mac_ie_proc_chwidth_field_etc(mac_vap_stru *pst_mac_vap,
                                                mac_user_stru *pst_mac_user,
                                                oal_uint8 uc_chwidth);

extern oal_uint32 mac_set_second_channel_offset_ie_etc(wlan_channel_bandwidth_enum_uint8 en_bw,
                                                       oal_uint8 *pauc_buffer,
                                                       oal_uint8 *puc_output_len);
extern oal_uint32 mac_set_11ac_wideband_ie_etc(oal_uint8 uc_channel,
                                               wlan_channel_bandwidth_enum_uint8 en_bw,
                                               oal_uint8 *pauc_buffer,
                                               oal_uint8 *puc_output_len);
...
extern oal_uint32 mac_ie_proc_ht_sta_etc(mac_vap_stru *pst_mac_sta,
...
extern oal_uint32 mac_ie_proc_he_opern_ie(mac_vap_stru *pst_mac_vap, oal_uint8 *puc_payload,
                                          mac_user_stru *pst_mac_user);
extern oal_uint32 mac_ie_parse_he_cap(oal_uint8 *puc_he_cap_ie, mac_frame_he_cap_ie_stru *pst_he_cap_value);
extern oal_uint32 mac_ie_from_he_cap_get_nss(mac_he_hdl_stru *pst_mac_he_hdl,
    wlan_nss_enum_uint8 *puc_nss);
extern oal_uint32 mac_ie_parse_he_oper(oal_uint8 *puc_he_oper_ie,
                                       mac_frame_he_oper_ie_stru *pst_he_oper_ie_value);
extern oal_uint32 mac_ie_parse_mu_edca_parameter(oal_uint8 *puc_he_edca_ie,
                                                 mac_frame_he_mu_edca_parameter_ie_stru *pst_he_mu_edca_value);
extern oal_uint32 mac_ie_parse_spatial_reuse_parameter(oal_uint8 *puc_he_cap_ie,
    mac_frame_he_spatial_reuse_parameter_set_ie_stru *pst_he_srp_value);
extern oal_uint32 mac_ie_parse_he_bss_color_change_announcement_ie(oal_uint8 *puc_payload,
    mac_frame_bss_color_change_annoncement_ie_stru *pst_bss_color);
extern oal_uint32 mac_ie_parse_he_ndp_feedback_report_ie(oal_uint8 *puc_he_ndp_ie,
                                                         oal_uint8 *puc_resource_req_buff_threshold_exp);
extern oal_uint32 mac_ie_parse_multi_bssid_opt_subie(oal_uint8 *puc_frame_data,
                                                     mac_multi_bssid_frame_info_stru *pst_mbssid_info,
                                                     oal_uint8 *puc_mbssid_body_ie_len);
#endif
extern oal_uint32 mac_proc_ht_opern_ie_etc(mac_vap_stru *pst_mac_vap, oal_uint8 *puc_payload,
                                           mac_user_stru *pst_mac_user);
extern oal_uint32 mac_ie_proc_vht_opern_ie_etc(mac_vap_stru *pst_mac_vap, oal_uint8 *puc_payload,
                                               mac_user_stru *pst_mac_user);
...
extern oal_uint16 mac_ie_get_max_mpdu_len_by_vht_cap(oal_uint8 uc_vht_cap_max_mpdu_len_bit);
#ifdef __cplusplus
#if __cplusplus
}
#endif
