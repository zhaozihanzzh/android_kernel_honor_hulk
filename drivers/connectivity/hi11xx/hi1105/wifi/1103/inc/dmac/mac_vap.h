...
#define MAC_VAP_BW_FSM_BEACON_AVAIL(_pst_mac_vap) \
    ((!IS_LEGACY_STA(_pst_mac_vap)) || (IS_LEGACY_STA(_pst_mac_vap) &&                                                  \
                                           (MAC_VAP_GET_CURREN_BW_STATE(_pst_mac_vap) > DMAC_STA_BW_SWITCH_FSM_INIT) && \
                                           (MAC_VAP_GET_CURREN_BW_STATE(_pst_mac_vap) < DMAC_STA_BW_SWITCH_FSM_INVALID)))
#define MAC_VAP_BW_FSM_VERIFY(_pst_mac_vap)                                             \
    ((DMAC_STA_BW_SWITCH_FSM_VERIFY20M == MAC_VAP_GET_CURREN_BW_STATE(_pst_mac_vap)) ||  \
...
#define MAC_BTCOEX_CHECK_VALID_STA(_pst_mac_vap)                                                          \
    ((IS_STA(_pst_mac_vap) &&                                                                             \
         (((_pst_mac_vap)->st_cap_flag.bit_bt20dbm) || (WLAN_BAND_2G == MAC_GET_VAP_BAND(_pst_mac_vap)))) \
            ? OAL_TRUE                                                                                    \
            : OAL_FALSE)
...
typedef struct {
    ...
    oal_uint8 csaIeFrameType;         /* 当前csa信息来自什么类型的帧 */
    oal_uint8 csaIeLastFrameType;     /* 上一次csa信息来自什么类型的帧 */
...
#ifdef _PRE_WLAN_FEATURE_11AX
    oal_uint8 bit_in_htc_blacklist   : 1, /* 当前user是否在htc blacklist表里 */
              bit_rev                : 7;
    oal_uint8 auc_rsv[3];
#endif
...
typedef oal_uint8 mac_probe_resp_mode_enum_uint8;
...
typedef oal_uint8 mac_ps_type_enum_uint8;
...
typedef struct {
    ...
    oal_uint8 bit_vap_support_csa : 1;
...
#endif
    oal_uint8 probe_resp_enable;
    oal_uint8 probe_resp_status;
    oal_uint8 resv2[2];
...
#define MAC_TOS_TO_SUBQ(_tos) ( \
    (((_tos) == 0) || ((_tos) == 3)) ? \
    MAC_LINUX_SUBQ_BE : (((_tos) == 1) || ((_tos) == 2)) ? \
    MAC_LINUX_SUBQ_BK : (((_tos) == 4) || ((_tos) == 5)) ? \
    MAC_LINUX_SUBQ_VI : MAC_LINUX_SUBQ_VO)
...
/* 8 UNION定义 */
/* 9 OTHERS定义 */
typedef oal_void (*ch_mib_by_bw)(mac_vap_stru *pst_mac_vap,
                                 wlan_channel_band_enum_uint8 en_band,
                                 wlan_channel_bandwidth_enum_uint8 en_bandwidth);
...
typedef oal_void (*init_rates_by_prot)(mac_vap_stru *pst_vap,
...
typedef oal_uint32 (*p_mac_vap_init_by_protocol_cb)(mac_vap_stru *pst_mac_vap,
                                                    wlan_protocol_enum_uint8 en_protocol);
...
typedef struct {
    ...
    oal_uint16 us_amsdu_throughput_middle;
...
typedef struct {
    ...
    oal_uint8 uc_cur_tcp_ack_buf_en[2];// 2代表2个vap
...
#ifdef _PRE_WLAN_FEATURE_HIEX
typedef struct {
    oal_uint8 tx_pwr_detail_2g[2];
    oal_uint8 tx_pwr_detail_5g[4][2];
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_pre_auth_actived(mac_vap_stru *pst_mac_vap,
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_rsnacfg_ptksareplaycounters(mac_vap_stru *pst_mac_vap,
                                                                       oal_uint8 uc_ptksa_replay_counters)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_rsnacfg_gtksareplaycounters(mac_vap_stru *pst_mac_vap,
                                                                       oal_uint8 uc_gtksa_replay_counters)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_rsn_group_mgmt_suite(mac_vap_stru *pst_mac_vap,
                                                                oal_uint32 ul_suite)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_wpa_pair_suites(mac_vap_stru *pst_mac_vap,
                                                           oal_uint32 *pul_suites)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_rsn_pair_suites(mac_vap_stru *pst_mac_vap,
                                                           oal_uint32 *pul_suites)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_wpa_akm_suites(mac_vap_stru *pst_mac_vap,
                                                          oal_uint32 *pul_suites)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_rsn_akm_suites(mac_vap_stru *pst_mac_vap,
                                                          oal_uint32 *pul_suites)
{
...
OAL_STATIC OAL_INLINE oal_uint32 mac_mib_wpa_pair_match_suites(mac_vap_stru *pst_mac_vap,
                                                               oal_uint32 *pul_suites)
{
...
OAL_STATIC OAL_INLINE oal_uint32 mac_mib_rsn_pair_match_suites(mac_vap_stru *pst_mac_vap,
                                                               oal_uint32 *pul_suites)
{
    oal_uint8 uc_idx_local;
    oal_uint8 uc_idx_peer;
...
OAL_STATIC OAL_INLINE oal_uint32 mac_mib_wpa_akm_match_suites(mac_vap_stru *pst_mac_vap,
                                                              oal_uint32 *pul_suites)
{
    oal_uint8 uc_idx_local;
    oal_uint8 uc_idx_peer;
...
OAL_STATIC OAL_INLINE oal_uint32 mac_mib_rsn_akm_match_suites(mac_vap_stru *pst_mac_vap,
                                                              oal_uint32 *pul_suites)
{
    oal_uint8 uc_idx_local;
    oal_uint8 uc_idx_peer;
...
OAL_STATIC OAL_INLINE oal_uint8 mac_mib_get_wpa_pair_suites(mac_vap_stru *pst_mac_vap,
                                                            oal_uint32 *pul_suites)
{
    oal_uint8 uc_loop;
    oal_uint8 uc_num = 0;
...
OAL_STATIC OAL_INLINE oal_uint8 mac_mib_get_rsn_pair_suites(mac_vap_stru *pst_mac_vap,
                                                            oal_uint32 *pul_suites)
{
    oal_uint8 uc_loop;
    oal_uint8 uc_num = 0;
...
OAL_STATIC OAL_INLINE oal_uint8 mac_mib_get_wpa_akm_suites(mac_vap_stru *pst_mac_vap,
                                                           oal_uint32 *pul_suites)
{
    oal_uint8 uc_num = 0;
    oal_uint8 uc_loop;
...
OAL_STATIC OAL_INLINE oal_uint8 mac_mib_get_rsn_akm_suites(mac_vap_stru *pst_mac_vap,
                                                           oal_uint32 *pul_suites)
{
    oal_uint8 uc_num = 0;
    oal_uint8 uc_loop;
...
OAL_STATIC OAL_INLINE oal_uint32 mac_mib_wpa_pair_match_suites_s(mac_vap_stru *pst_mac_vap,
                                                                 oal_uint32 *pul_suites,
...
OAL_STATIC OAL_INLINE oal_uint32 mac_mib_rsn_pair_match_suites_s(mac_vap_stru *pst_mac_vap,
                                                                 oal_uint32 *pul_suites,
                                                                 oal_uint8 uc_cipher_len)
{
    oal_uint8 uc_idx_local;
...
OAL_STATIC OAL_INLINE oal_uint32 mac_mib_wpa_akm_match_suites_s(mac_vap_stru *pst_mac_vap,
                                                                oal_uint32 *pul_suites,
                                                                oal_uint8 uc_cipher_len)
{
    oal_uint8 uc_idx_local;
...
OAL_STATIC OAL_INLINE oal_uint32 mac_mib_rsn_akm_match_suites_s(mac_vap_stru *pst_mac_vap,
                                                                oal_uint32 *pul_suites,
                                                                oal_uint8 uc_cipher_len)
{
    oal_uint8 uc_idx_local;
...
OAL_STATIC OAL_INLINE oal_uint8 mac_mib_get_wpa_pair_suites_s(mac_vap_stru *pst_mac_vap,
                                                              oal_uint32 *pul_suites,
                                                              oal_uint8 uc_cipher_len)
{
    oal_uint8 uc_loop;
...
OAL_STATIC OAL_INLINE oal_uint8 mac_mib_get_rsn_pair_suites_s(mac_vap_stru *pst_mac_vap,
                                                              oal_uint32 *pul_suites,
                                                              oal_uint8 uc_cipher_len)
{
    oal_uint8 uc_loop;
...
OAL_STATIC OAL_INLINE oal_uint8 mac_mib_get_wpa_akm_suites_s(mac_vap_stru *pst_mac_vap,
                                                             oal_uint32 *pul_suites,
                                                             oal_uint8 uc_cipher_len)
{
    oal_uint8 uc_num = 0;
...
OAL_STATIC OAL_INLINE oal_uint8 mac_mib_get_rsn_akm_suites_s(mac_vap_stru *pst_mac_vap,
                                                             oal_uint32 *pul_suites,
                                                             oal_uint8 uc_cipher_len)
{
    oal_uint8 uc_num = 0;
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_maxmpdu_length(mac_vap_stru *pst_mac_vap,
                                                          oal_uint32 ul_maxmpdu_length)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_vht_max_rx_ampdu_factor(mac_vap_stru *pst_mac_vap,
                                                                   oal_uint32 ul_vht_max_rx_ampdu_factor)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_vht_ctrl_field_cap(mac_vap_stru *pst_mac_vap,
                                                              oal_bool_enum_uint8 en_vht_ctrl_field_supported)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_vht_rx_mcs_map(mac_vap_stru *pst_mac_vap,
                                                          oal_uint16 us_vht_mcs_mpa)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_us_rx_highest_rate(mac_vap_stru *pst_mac_vap,
                                                              oal_uint32 ul_rx_highest_rate)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_vht_tx_mcs_map(mac_vap_stru *pst_mac_vap,
                                                          oal_uint16 us_vht_mcs_mpa)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_us_tx_highest_rate(mac_vap_stru *pst_mac_vap,
                                                              oal_uint32 ul_tx_highest_rate)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_smps(mac_vap_stru *pst_mac_vap,
                                                wlan_mib_mimo_power_save_enum_uint8 en_sm_power_save)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_max_amsdu_length(mac_vap_stru *pst_mac_vap,
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_lsig_txop_protection(mac_vap_stru *pst_mac_vap,
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_max_ampdu_len_exponent(mac_vap_stru *pst_mac_vap,
                                                                  oal_uint32 ul_max_ampdu_len_exponent)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_min_mpdu_start_spacing(mac_vap_stru *pst_mac_vap,
                                                                  oal_uint8 ul_min_mpdu_start_spacing)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_pco_option_implemented(mac_vap_stru *pst_mac_vap,
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_transition_time(mac_vap_stru *pst_mac_vap,
                                                           oal_uint32 ul_transition_time)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_mcs_fdbk(mac_vap_stru *pst_mac_vap,
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_ft_trainsistion(mac_vap_stru *pst_mac_vap,
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_ft_over_ds(mac_vap_stru *pst_mac_vap,
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_ft_resource_req(mac_vap_stru *pst_mac_vap,
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_privacyinvoked(mac_vap_stru *pst_mac_vap,
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_rsnaactivated(mac_vap_stru *pst_mac_vap,
...
OAL_STATIC OAL_INLINE oal_void mac_set_wep_default_keyid(mac_vap_stru *pst_mac_vap,
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_OBSSScanPassiveDwell(mac_vap_stru *pst_mac_vap,
                                                                oal_uint32 ul_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_OBSSScanActiveDwell(mac_vap_stru *pst_mac_vap,
                                                               oal_uint32 ul_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_BSSWidthTriggerScanInterval(mac_vap_stru *pst_mac_vap,
                                                                       oal_uint32 ul_val)
{
...
OAL_STATIC OAL_INLINE oal_uint32 mac_mib_get_OBSSScanPassiveTotalPerChannel(
    mac_vap_stru *pst_mac_vap)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_OBSSScanPassiveTotalPerChannel(
...
OAL_STATIC OAL_INLINE oal_uint32 mac_mib_get_OBSSScanActiveTotalPerChannel(
    mac_vap_stru *pst_mac_vap)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_OBSSScanActiveTotalPerChannel(
    mac_vap_stru *pst_mac_vap, oal_uint32 ul_val)
{
...
OAL_STATIC OAL_INLINE oal_uint32 mac_mib_get_BSSWidthChannelTransitionDelayFactor(
    mac_vap_stru *pst_mac_vap)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_OBSSScanActivityThreshold(mac_vap_stru *pst_mac_vap,
                                                                     oal_uint32 ul_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_VHTOptionImplemented(mac_vap_stru *pst_mac_vap,
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_HEOptionImplemented(mac_vap_stru *pst_mac_vap,
                                                               oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_OMIOptionImplemented(mac_vap_stru *pst_mac_vap,
                                                                oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_he_TWTOptionActivated(mac_vap_stru *pst_mac_vap,
                                                                 oal_bool_enum_uint8 en_val)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void mac_mib_set_he_OperatingModeIndication(mac_vap_stru *pst_mac_vap,
                                                                      oal_bool_enum_uint8 en_val)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void mac_mib_set_he_BSRSupport(mac_vap_stru *pst_mac_vap,
                                                         oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_he_BQRSupport(mac_vap_stru *pst_mac_vap,
                                                         oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_he_OFDMARandomAccess(mac_vap_stru *pst_mac_vap,
                                                                oal_bool_enum_uint8 en_val)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void mac_mib_set_he_TriggerMacPaddingDuration(mac_vap_stru *pst_mac_vap,
                                                                        oal_uint8 uc_val)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void mac_mib_set_he_MultiBSSIDImplemented(mac_vap_stru *pst_mac_vap,
                                                                    oal_uint8 uc_val)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void mac_mib_set_he_MaxAMPDULengthExponent(mac_vap_stru *pst_mac_vap,
                                                                     oal_uint8 uc_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_he_rx_mcs_map(mac_vap_stru *pst_mac_vap,
                                                         oal_uint32 ul_he_mcs_map)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_he_tx_mcs_map(mac_vap_stru *pst_mac_vap,
                                                         oal_uint32 ul_he_mcs_map)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void mac_mib_set_he_DualBandSupport(mac_vap_stru *pst_mac_vap,
                                                              oal_uint8 uc_val)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void mac_mib_set_he_LDPCCodingInPayload(mac_vap_stru *pst_mac_vap,
                                                                  oal_bool_enum_uint8 en_val)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void mac_mib_set_he_SUBeamformer(mac_vap_stru *pst_mac_vap,
                                                           oal_bool_enum_uint8 en_val)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void mac_mib_set_he_SUBeamformee(mac_vap_stru *pst_mac_vap,
                                                           oal_bool_enum_uint8 en_val)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void mac_mib_set_he_MUBeamformer(mac_vap_stru *pst_mac_vap,
                                                           oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_he_BeamformeeSTSBelow80Mhz(
    mac_vap_rom_stru *pst_mac_vap_rom, oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_he_BeamformeeSTSOver80Mhz(
    mac_vap_rom_stru *pst_mac_vap_rom, oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_HENumberSoundingDimensionsBelow80Mhz(
    mac_vap_rom_stru *pst_mac_vap_rom, oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_HENumberSoundingDimensionsOver80Mhz(
    mac_vap_rom_stru *pst_mac_vap_rom, oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_HENg16SUFeedback(mac_vap_rom_stru *pst_mac_vap_rom,
                                                            oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_HENg16MUFeedback(mac_vap_rom_stru *pst_mac_vap_rom,
                                                            oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_HECodebook42SUFeedback(
    mac_vap_rom_stru *pst_mac_vap_rom, oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_HECodebook75MUFeedback(
    mac_vap_rom_stru *pst_mac_vap_rom, oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_he_TriggeredSUBeamformingFeedback(
    mac_vap_rom_stru *pst_mac_vap_rom, oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_he_TriggeredCQIFeedback(mac_vap_rom_stru *pst_mac_vap_rom,
                                                                   oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_he_MultiBSSIDActived(mac_vap_rom_stru *pst_mac_vap_rom,
                                                                oal_bool_enum_uint8 en_val)
{
 ...
 *   修改内容  : 新生成函数
 */
OAL_STATIC OAL_INLINE oal_void mac_mib_set_he_HEChannelWidthSet(mac_vap_stru *pst_mac_vap,
                                                                oal_uint8 uc_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_FortyMHzOperationImplemented(mac_vap_stru *pst_mac_vap,
                                                                        oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_2GFortyMHzOperationImplemented(
    mac_vap_stru *pst_mac_vap, oal_bool_enum_uint8 en_val)
{
    pst_mac_vap->pst_mib_info->st_wlan_mib_phy_ht.en_dot112GFortyMHzOperationImplemented = en_val;
}

OAL_STATIC OAL_INLINE oal_void mac_mib_set_5GFortyMHzOperationImplemented(
    mac_vap_stru *pst_mac_vap, oal_bool_enum_uint8 en_val)
{
    pst_mac_vap->pst_mib_info->st_wlan_mib_phy_ht.en_dot115GFortyMHzOperationImplemented = en_val;
}
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_FortyMHzIntolerant(mac_vap_stru *pst_mac_vap,
                                                              oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_dot11RSNAMFPC(mac_vap_stru *pst_mac_vap,
                                                         oal_bool_enum_uint8 ul_val)
{
    pst_mac_vap->pst_mib_info->st_wlan_mib_privacy.en_dot11RSNAMFPC = ul_val;
}

OAL_STATIC OAL_INLINE oal_void mac_mib_set_dot11RSNAMFPR(mac_vap_stru *pst_mac_vap,
                                                         oal_bool_enum_uint8 ul_val)
{
...
OAL_STATIC OAL_INLINE oal_uint32 mac_mib_get_dot11AssociationSAQueryMaximumTimeout(
    mac_vap_stru *pst_mac_vap)
{
    return pst_mac_vap->pst_mib_info->st_wlan_mib_sta_config.ul_dot11AssociationSAQueryMaximumTimeout;
}

OAL_STATIC OAL_INLINE oal_uint32 mac_mib_get_dot11AssociationSAQueryRetryTimeout(
    mac_vap_stru *pst_mac_vap)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_dot11ExtendedChannelSwitchActivated(
    mac_vap_stru *pst_mac_vap, oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_dot11QBSSLoadImplemented(mac_vap_stru *pst_mac_vap,
                                                                    oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_dot11VHTExtendedNSSBWCapable(
    mac_vap_stru *pst_mac_vap, oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_dot11APSDOptionImplemented(
    mac_vap_stru *pst_mac_vap, oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_dot11DelayedBlockAckOptionImplemented(
    mac_vap_stru *pst_mac_vap, oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_dot11ImmediateBlockAckOptionImplemented(
    mac_vap_stru *pst_mac_vap, oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_dot11QosOptionImplemented(mac_vap_stru *pst_mac_vap,
                                                                     oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_dot11MultiDomainCapabilityActivated(
    mac_vap_stru *pst_mac_vap, oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_dot11AssociationResponseTimeOut(
    mac_vap_stru *pst_mac_vap, oal_uint32 en_val)
{
    pst_mac_vap->pst_mib_info->st_wlan_mib_sta_config.ul_dot11AssociationResponseTimeOut = en_val;
}

OAL_STATIC OAL_INLINE oal_uint32 mac_mib_get_dot11AssociationResponseTimeOut(
    mac_vap_stru *pst_mac_vap)
{
    return pst_mac_vap->pst_mib_info->st_wlan_mib_sta_config.ul_dot11AssociationResponseTimeOut;
}

OAL_STATIC OAL_INLINE oal_void mac_mib_set_MaxAssocUserNums(mac_vap_stru *pst_mac_vap,
                                                            oal_uint16 us_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_SupportRateSetNums(mac_vap_stru *pst_mac_vap,
                                                              oal_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_AmsduAggregateAtive(mac_vap_stru *pst_mac_vap,
                                                               oal_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_AmsduPlusAmpduActive(mac_vap_stru *pst_mac_vap,
                                                                oal_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_2040SwitchProhibited(mac_vap_stru *pst_mac_vap,
                                                                oal_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_TxAggregateActived(mac_vap_stru *pst_mac_vap,
                                                              oal_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_CfgAmpduTxAtive(mac_vap_stru *pst_mac_vap,
                                                           oal_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_RxBASessionNumber(mac_vap_stru *pst_mac_vap,
                                                             oal_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_TxBASessionNumber(mac_vap_stru *pst_mac_vap,
                                                             oal_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_AuthenticationMode(mac_vap_stru *pst_mac_vap,
                                                              oal_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_TxTrafficClassifyFlag(mac_vap_stru *pst_mac_vap,
                                                                 oal_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_dot11RMBeaconActiveMeasurementActivated(
    mac_vap_stru *pst_mac_vap, oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_dot11RMBeaconPassiveMeasurementActivated(
    mac_vap_stru *pst_mac_vap, oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_dot11RMLinkMeasurementActivated(
    mac_vap_stru *pst_mac_vap, oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_dot11RMChannelLoadMeasurementActivated(
    mac_vap_stru *pst_mac_vap, oal_bool_enum_uint8 en_val)
{
    pst_mac_vap->pst_mib_info->st_wlan_mib_sta_config.en_dot11RMChannelLoadMeasurementActivated = en_val;
}

OAL_STATIC OAL_INLINE oal_bool_enum_uint8 mac_mib_get_dot11RMChannelLoadMeasurementActivated(
    mac_vap_stru *pst_mac_vap)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_dot11RMNeighborReportActivated(
    mac_vap_stru *pst_mac_vap, oal_bool_enum_uint8 en_val)
{
    pst_mac_vap->pst_mib_info->st_wlan_mib_sta_config.en_dot11RMNeighborReportActivated = en_val;
}

OAL_STATIC OAL_INLINE oal_bool_enum_uint8 mac_mib_get_dot11RMNeighborReportActivated(
    mac_vap_stru *pst_mac_vap)
{
    return pst_mac_vap->pst_mib_info->st_wlan_mib_sta_config.en_dot11RMNeighborReportActivated;
}

OAL_STATIC OAL_INLINE oal_bool_enum_uint8 mac_mib_get_dot11RMParallelMeasurementsActivated(
    mac_vap_stru *pst_mac_vap)
{
    return pst_mac_vap->pst_mib_info->st_wlan_mib_sta_config.en_dot11RMParallelMeasurementsActivated;
}

OAL_STATIC OAL_INLINE oal_bool_enum_uint8 mac_mib_get_dot11RMRepeatedMeasurementsActivated(
    mac_vap_stru *pst_mac_vap)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_dot11VapMaxBandWidth(mac_vap_stru *pst_mac_vap,
                                                                wlan_channel_bandwidth_enum_uint8 en_bandwidth)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_AuthenticationResponseTimeOut(
    mac_vap_stru *pst_mac_vap, oal_uint32 ul_val)
{
    pst_mac_vap->pst_mib_info->st_wlan_mib_sta_config.ul_dot11AuthenticationResponseTimeOut = ul_val;
}
OAL_STATIC OAL_INLINE oal_uint32 mac_mib_get_AuthenticationResponseTimeOut(
    mac_vap_stru *pst_mac_vap)
{
...
#if defined(_PRE_WLAN_FEATURE_11V) || (defined(_PRE_WLAN_FEATURE_FTM)) || defined(_PRE_WLAN_FEATURE_11V_ENABLE)
OAL_STATIC OAL_INLINE oal_void mac_mib_set_FtmInitiatorModeActivated(mac_vap_stru *pst_mac_vap,
                                                                     oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_FtmResponderModeActivated(mac_vap_stru *pst_mac_vap,
    oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_FtmRangeReportActivated(mac_vap_stru *pst_mac_vap,
                                                                   oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_powermanagementmode(mac_vap_stru *pst_mac_vap,
                                                               oal_uint8 uc_val)
{
    if (uc_val != 0) {
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_LsigTxopFullProtectionActivated(mac_vap_stru *pst_mac_vap,
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_NonGFEntitiesPresent(mac_vap_stru *pst_mac_vap,
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_RifsMode(mac_vap_stru *pst_mac_vap,
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_DualCTSProtection(mac_vap_stru *pst_mac_vap,
                                                             oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_PCOActivated(mac_vap_stru *pst_mac_vap,
                                                        oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_HtProtection(mac_vap_stru *pst_mac_vap,
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_SpectrumManagementRequired(mac_vap_stru *pst_mac_vap,
                                                                      oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_2GShortGIOptionInFortyImplemented(
    mac_vap_stru *pst_mac_vap, oal_bool_enum_uint8 en_val)
{
    pst_mac_vap->pst_mib_info->st_wlan_mib_phy_ht.en_dot112GShortGIOptionInFortyImplemented = en_val;
}

OAL_STATIC OAL_INLINE oal_void mac_mib_set_5GShortGIOptionInFortyImplemented(
    mac_vap_stru *pst_mac_vap, oal_bool_enum_uint8 en_val)
{
    pst_mac_vap->pst_mib_info->st_wlan_mib_phy_ht.en_dot115GShortGIOptionInFortyImplemented = en_val;
}
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_FragmentationThreshold(mac_vap_stru *pst_mac_vap,
                                                                  oal_uint32 ul_frag_threshold)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_RTSThreshold(mac_vap_stru *pst_mac_vap,
                                                        oal_uint32 ul_rts_threshold)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_AntennaSelectionOptionImplemented(
    mac_vap_stru *pst_mac_vap, oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_TransmitExplicitCSIFeedbackASOptionImplemented(
    mac_vap_stru *pst_mac_vap, oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_TransmitIndicesFeedbackASOptionImplemented(
    mac_vap_stru *pst_mac_vap, oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_ExplicitCSIFeedbackASOptionImplemented(
    mac_vap_stru *pst_mac_vap, oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_ReceiveAntennaSelectionOptionImplemented(
    mac_vap_stru *pst_mac_vap, oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_TransmitSoundingPPDUOptionImplemented(
    mac_vap_stru *pst_mac_vap, oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_PBCCOptionImplemented(mac_vap_stru *pst_mac_vap,
                                                                 oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_ChannelAgilityPresent(mac_vap_stru *pst_mac_vap,
                                                                 oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_DSSSOFDMOptionActivated(mac_vap_stru *pst_mac_vap,
                                                                   oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_ShortSlotTimeOptionImplemented(mac_vap_stru *pst_mac_vap,
                                                                          oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_ShortSlotTimeOptionActivated(mac_vap_stru *pst_mac_vap,
                                                                        oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_ReceiveStaggerSoundingOptionImplemented(
    mac_vap_stru *pst_mac_vap, oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_TransmitStaggerSoundingOptionImplemented(
    mac_vap_stru *pst_mac_vap, oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_ReceiveNDPOptionImplemented(mac_vap_stru *pst_mac_vap,
                                                                       oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_TransmitNDPOptionImplemented(mac_vap_stru *pst_mac_vap,
                                                                        oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_ImplicitTransmitBeamformingOptionImplemented(
    mac_vap_stru *pst_mac_vap, oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_CalibrationOptionImplemented(mac_vap_stru *pst_mac_vap,
                                                                        oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_ExplicitCSITransmitBeamformingOptionImplemented(
    mac_vap_stru *pst_mac_vap, oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_NumberBeamFormingCSISupportAntenna(
    mac_vap_stru *pst_mac_vap, oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_VHTSUBeamformeeOptionImplemented(
    mac_vap_stru *pst_mac_vap, oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_VHTSUBeamformerOptionImplemented(
    mac_vap_stru *pst_mac_vap, oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_VHTMUBeamformeeOptionImplemented(
    mac_vap_stru *pst_mac_vap, oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_VHTMUBeamformerOptionImplemented(
    mac_vap_stru *pst_mac_vap, oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_VHTNumberSoundingDimensions(mac_vap_stru *pst_mac_vap,
                                                                       oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_VHTBeamformeeNTxSupport(mac_vap_stru *pst_mac_vap,
                                                                   oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_VHTChannelWidthOptionImplemented(
...
OAL_STATIC OAL_INLINE oal_uint8 mac_mib_get_VHTChannelWidthOptionImplemented(
    mac_vap_stru *pst_mac_vap)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_VHTShortGIOptionIn80Implemented(
    mac_vap_stru *pst_mac_vap, oal_bool_enum_uint8 en_val)
{
    pst_mac_vap->pst_mib_info->st_wlan_mib_phy_vht.en_dot11VHTShortGIOptionIn80Implemented = en_val;
}

OAL_STATIC OAL_INLINE oal_uint8 mac_mib_get_VHTShortGIOptionIn80Implemented(
    mac_vap_stru *pst_mac_vap)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_VHTShortGIOptionIn160and80p80Implemented(
    mac_vap_stru *pst_mac_vap, oal_bool_enum_uint8 en_val)
{
    pst_mac_vap->pst_mib_info->st_wlan_mib_phy_vht.en_dot11VHTShortGIOptionIn160and80p80Implemented = en_val;
}

OAL_STATIC OAL_INLINE oal_uint8 mac_mib_get_VHTShortGIOptionIn160and80p80Implemented(
    mac_vap_stru *pst_mac_vap)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_VHTLDPCCodingOptionImplemented(
    mac_vap_stru *pst_mac_vap, oal_bool_enum_uint8 en_val)
{
    pst_mac_vap->pst_mib_info->st_wlan_mib_phy_vht.en_dot11VHTLDPCCodingOptionImplemented = en_val;
}

OAL_STATIC OAL_INLINE oal_uint8 mac_mib_get_VHTLDPCCodingOptionImplemented(
    mac_vap_stru *pst_mac_vap)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_VHTTxSTBCOptionImplemented(mac_vap_stru *pst_mac_vap,
                                                                      oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_VHTRxSTBCOptionImplemented(mac_vap_stru *pst_mac_vap,
                                                                      oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_HTGreenfieldOptionImplemented(mac_vap_stru *pst_mac_vap,
                                                                         oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_ShortGIOptionInTwentyImplemented(
    mac_vap_stru *pst_mac_vap, oal_bool_enum_uint8 en_val)
{
    pst_mac_vap->pst_mib_info->st_wlan_mib_phy_ht.en_dot11ShortGIOptionInTwentyImplemented = en_val;
}

OAL_STATIC OAL_INLINE oal_uint8 mac_mib_get_ShortGIOptionInTwentyImplemented(
    mac_vap_stru *pst_mac_vap)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_LDPCCodingOptionImplemented(mac_vap_stru *pst_mac_vap,
                                                                       oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_LDPCCodingOptionActivated(mac_vap_stru *pst_mac_vap,
                                                                     oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_TxSTBCOptionImplemented(mac_vap_stru *pst_mac_vap,
                                                                   oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_TxSTBCOptionActivated(mac_vap_stru *pst_mac_vap,
                                                                 oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_RxSTBCOptionImplemented(mac_vap_stru *pst_mac_vap,
                                                                   oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_HighestSupportedDataRate(mac_vap_stru *pst_mac_vap,
                                                                    oal_uint32 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_TxMCSSetDefined(mac_vap_stru *pst_mac_vap,
                                                           oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_TxRxMCSSetNotEqual(mac_vap_stru *pst_mac_vap,
                                                              oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_TxMaximumNumberSpatialStreamsSupported(
    mac_vap_stru *pst_mac_vap, oal_uint32 en_val)
{
    pst_mac_vap->pst_mib_info->st_wlan_mib_phy_ht.ul_dot11TxMaximumNumberSpatialStreamsSupported = en_val;
}

OAL_STATIC OAL_INLINE oal_uint32 mac_mib_get_TxMaximumNumberSpatialStreamsSupported(
    mac_vap_stru *pst_mac_vap)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_TxUnequalModulationSupported(mac_vap_stru *pst_mac_vap,
                                                                        oal_bool_enum_uint8 en_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_SupportedMCSTxValue(mac_vap_stru *pst_mac_vap,
                                                               oal_uint8 uc_index, oal_uint8 uc_val)
{
    pst_mac_vap->pst_mib_info->st_supported_mcs.st_supported_mcstx.auc_dot11SupportedMCSTxValue[uc_index] = uc_val;
}

OAL_STATIC OAL_INLINE oal_uint8 mac_mib_get_SupportedMCSTxValue(mac_vap_stru *pst_mac_vap,
                                                                oal_uint8 uc_index)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_SupportedMCSRxValue(mac_vap_stru *pst_mac_vap,
                                                               oal_uint8 uc_index, oal_uint8 uc_val)
{
    pst_mac_vap->pst_mib_info->st_supported_mcs.st_supported_mcsrx.auc_dot11SupportedMCSRxValue[uc_index] = uc_val;
}

OAL_STATIC OAL_INLINE oal_uint8 mac_mib_get_SupportedMCSRxValue(mac_vap_stru *pst_mac_vap,
                                                                oal_uint8 uc_index)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_EDCATableIndex(mac_vap_stru *pst_mac_vap,
                                                          oal_uint8 uc_index,
                                                          oal_uint32 ul_val)
{
...
OAL_STATIC OAL_INLINE oal_uint32 mac_mib_get_EDCATableIndex(mac_vap_stru *pst_mac_vap,
                                                            oal_uint8 uc_index)
{
    return pst_mac_vap->pst_mib_info->st_wlan_mib_edca.ast_wlan_mib_edca[uc_index].ul_dot11EDCATableIndex;
}

OAL_STATIC OAL_INLINE oal_void mac_mib_set_EDCATableCWmin(mac_vap_stru *pst_mac_vap,
                                                          oal_uint8 uc_index,
                                                          oal_uint32 ul_val)
{
...
OAL_STATIC OAL_INLINE oal_uint32 mac_mib_get_EDCATableCWmin(mac_vap_stru *pst_mac_vap,
    oal_uint8 uc_index)
{
    return pst_mac_vap->pst_mib_info->st_wlan_mib_edca.ast_wlan_mib_edca[uc_index].ul_dot11EDCATableCWmin;
}

OAL_STATIC OAL_INLINE oal_void mac_mib_set_EDCATableCWmax(mac_vap_stru *pst_mac_vap,
                                                          oal_uint8 uc_index,
                                                          oal_uint32 ul_val)
{
...
OAL_STATIC OAL_INLINE oal_uint32 mac_mib_get_EDCATableCWmax(mac_vap_stru *pst_mac_vap,
                                                            oal_uint8 uc_index)
{
    return pst_mac_vap->pst_mib_info->st_wlan_mib_edca.ast_wlan_mib_edca[uc_index].ul_dot11EDCATableCWmax;
}

OAL_STATIC OAL_INLINE oal_void mac_mib_set_EDCATableAIFSN(mac_vap_stru *pst_mac_vap,
                                                          oal_uint8 uc_index,
                                                          oal_uint32 ul_val)
{
...
OAL_STATIC OAL_INLINE oal_uint32 mac_mib_get_EDCATableAIFSN(mac_vap_stru *pst_mac_vap,
                                                            oal_uint8 uc_index)
{
    return pst_mac_vap->pst_mib_info->st_wlan_mib_edca.ast_wlan_mib_edca[uc_index].ul_dot11EDCATableAIFSN;
}

OAL_STATIC OAL_INLINE oal_void mac_mib_set_EDCATableTXOPLimit(mac_vap_stru *pst_mac_vap,
                                                              oal_uint8 uc_index, oal_uint32 ul_val)
{
    pst_mac_vap->pst_mib_info->st_wlan_mib_edca.ast_wlan_mib_edca[uc_index].ul_dot11EDCATableTXOPLimit = ul_val;
}

OAL_STATIC OAL_INLINE oal_uint32 mac_mib_get_EDCATableTXOPLimit(mac_vap_stru *pst_mac_vap,
                                                                oal_uint8 uc_index)
{
    return pst_mac_vap->pst_mib_info->st_wlan_mib_edca.ast_wlan_mib_edca[uc_index].ul_dot11EDCATableTXOPLimit;
}

OAL_STATIC OAL_INLINE oal_void mac_mib_set_EDCATableMandatory(mac_vap_stru *pst_mac_vap,
                                                              oal_uint8 uc_index, oal_uint8 uc_val)
{
    pst_mac_vap->pst_mib_info->st_wlan_mib_edca.ast_wlan_mib_edca[uc_index].en_dot11EDCATableMandatory = uc_val;
}

OAL_STATIC OAL_INLINE oal_uint8 mac_mib_get_EDCATableMandatory(mac_vap_stru *pst_mac_vap,
                                                               oal_uint8 uc_index)
{
    return pst_mac_vap->pst_mib_info->st_wlan_mib_edca.ast_wlan_mib_edca[uc_index].en_dot11EDCATableMandatory;
}

OAL_STATIC OAL_INLINE oal_void mac_mib_set_QAPEDCATableIndex(mac_vap_stru *pst_mac_vap,
                                                             oal_uint8 uc_index,
                                                             oal_uint32 ul_val)
{
...
OAL_STATIC OAL_INLINE oal_uint32 mac_mib_get_QAPEDCATableIndex(mac_vap_stru *pst_mac_vap,
                                                               oal_uint8 uc_index)
{
    return pst_mac_vap->pst_mib_info->st_wlan_mib_edca.ast_wlan_mib_qap_edac[uc_index].ul_dot11QAPEDCATableIndex;
}

OAL_STATIC OAL_INLINE oal_void mac_mib_set_QAPEDCATableCWmin(mac_vap_stru *pst_mac_vap,
                                                             oal_uint8 uc_index,
                                                             oal_uint32 ul_val)
{
...
OAL_STATIC OAL_INLINE oal_uint32 mac_mib_get_QAPEDCATableCWmin(mac_vap_stru *pst_mac_vap,
                                                               oal_uint8 uc_index)
{
    return pst_mac_vap->pst_mib_info->st_wlan_mib_edca.ast_wlan_mib_qap_edac[uc_index].ul_dot11QAPEDCATableCWmin;
}

OAL_STATIC OAL_INLINE oal_void mac_mib_set_QAPEDCATableCWmax(mac_vap_stru *pst_mac_vap,
                                                             oal_uint8 uc_index,
                                                             oal_uint32 ul_val)
{
...
OAL_STATIC OAL_INLINE oal_uint32 mac_mib_get_QAPEDCATableCWmax(mac_vap_stru *pst_mac_vap,
                                                               oal_uint8 uc_index)
{
    return pst_mac_vap->pst_mib_info->st_wlan_mib_edca.ast_wlan_mib_qap_edac[uc_index].ul_dot11QAPEDCATableCWmax;
}

OAL_STATIC OAL_INLINE oal_void mac_mib_set_QAPEDCATableAIFSN(mac_vap_stru *pst_mac_vap,
                                                             oal_uint8 uc_index,
                                                             oal_uint32 ul_val)
{
...
OAL_STATIC OAL_INLINE oal_uint32 mac_mib_get_QAPEDCATableAIFSN(mac_vap_stru *pst_mac_vap,
                                                               oal_uint8 uc_index)
{
    return pst_mac_vap->pst_mib_info->st_wlan_mib_edca.ast_wlan_mib_qap_edac[uc_index].ul_dot11QAPEDCATableAIFSN;
}

OAL_STATIC OAL_INLINE oal_void mac_mib_set_QAPEDCATableTXOPLimit(mac_vap_stru *pst_mac_vap,
                                                                 oal_uint8 uc_index,
                                                                 oal_uint32 ul_val)
{
...
OAL_STATIC OAL_INLINE oal_uint32 mac_mib_get_QAPEDCATableTXOPLimit(mac_vap_stru *pst_mac_vap,
                                                                   oal_uint8 uc_index)
{
    return pst_mac_vap->pst_mib_info->st_wlan_mib_edca.ast_wlan_mib_qap_edac[uc_index].ul_dot11QAPEDCATableTXOPLimit;
}

OAL_STATIC OAL_INLINE oal_void mac_mib_set_QAPEDCATableMandatory(mac_vap_stru *pst_mac_vap,
                                                                 oal_uint8 uc_index,
                                                                 oal_uint8 uc_val)
{
...
OAL_STATIC OAL_INLINE oal_uint8 mac_mib_get_QAPEDCATableMandatory(mac_vap_stru *pst_mac_vap,
                                                                  oal_uint8 uc_index)
{
    return pst_mac_vap->pst_mib_info->st_wlan_mib_edca.ast_wlan_mib_qap_edac[uc_index].en_dot11QAPEDCATableMandatory;
}

OAL_STATIC OAL_INLINE oal_void mac_mib_set_QAPEDCATableMSDULifetime(mac_vap_stru *pst_mac_vap,
                                                                    oal_uint8 uc_index,
                                                                    oal_uint32 ul_val)
{
...
OAL_STATIC OAL_INLINE oal_uint32 mac_mib_get_QAPEDCATableMSDULifetime(mac_vap_stru *pst_mac_vap,
                                                                      oal_uint8 uc_index)
{
...
#ifdef _PRE_WLAN_FEATURE_11AX
OAL_STATIC OAL_INLINE oal_void mac_mib_set_QAPMUEDCATableIndex(mac_vap_rom_stru *pst_mac_vap_rom,
                                                               oal_uint8 uc_index,
                                                               oal_uint32 ul_val)
{
...
OAL_STATIC OAL_INLINE oal_void mac_mib_set_QAPMUEDCATableCWmin(mac_vap_rom_stru *pst_mac_vap_rom,
                                                               oal_uint8 uc_index,
                                                               oal_uint32 ul_val)
{
...
OAL_STATIC OAL_INLINE oal_uint32 mac_mib_get_QAPMUEDCATableCWmin(
    mac_vap_rom_stru *pst_mac_vap_rom, oal_uint8 uc_index)
{
    return pst_mac_vap_rom->st_wlan_mib_mu_edca.ast_wlan_mib_qap_edac[uc_index].ul_dot11QAPEDCATableCWmin;
}

OAL_STATIC OAL_INLINE oal_void mac_mib_set_QAPMUEDCATableCWmax(mac_vap_rom_stru *pst_mac_vap_rom,
                                                               oal_uint8 uc_index,
                                                               oal_uint32 ul_val)
{
...
OAL_STATIC OAL_INLINE oal_uint32 mac_mib_get_QAPMUEDCATableCWmax(
    mac_vap_rom_stru *pst_mac_vap_rom, oal_uint8 uc_index)
{
    return pst_mac_vap_rom->st_wlan_mib_mu_edca.ast_wlan_mib_qap_edac[uc_index].ul_dot11QAPEDCATableCWmax;
}

OAL_STATIC OAL_INLINE oal_void mac_mib_set_QAPMUEDCATableAIFSN(mac_vap_rom_stru *pst_mac_vap_rom,
                                                               oal_uint8 uc_index,
                                                               oal_uint32 ul_val)
{
...
OAL_STATIC OAL_INLINE oal_uint32 mac_mib_get_QAPMUEDCATableAIFSN(mac_vap_rom_stru *pst_mac_vap_rom,
                                                                 oal_uint8 uc_index)
{
    return pst_mac_vap_rom->st_wlan_mib_mu_edca.ast_wlan_mib_qap_edac[uc_index].ul_dot11QAPEDCATableAIFSN;
}

OAL_STATIC OAL_INLINE oal_void mac_mib_set_QAPMUEDCATableTXOPLimit(
    mac_vap_rom_stru *pst_mac_vap_rom, oal_uint8 uc_index, oal_uint32 ul_val)
{
    pst_mac_vap_rom->st_wlan_mib_mu_edca.ast_wlan_mib_qap_edac[uc_index].ul_dot11QAPEDCATableTXOPLimit = ul_val;
}

OAL_STATIC OAL_INLINE oal_uint32 mac_mib_get_QAPMUEDCATableTXOPLimit(
    mac_vap_rom_stru *pst_mac_vap_rom, oal_uint8 uc_index)
{
    return pst_mac_vap_rom->st_wlan_mib_mu_edca.ast_wlan_mib_qap_edac[uc_index].ul_dot11QAPEDCATableTXOPLimit;
}

OAL_STATIC OAL_INLINE oal_void mac_mib_set_QAPMUEDCATableMandatory(
    mac_vap_rom_stru *pst_mac_vap_rom, oal_uint8 uc_index, oal_uint8 uc_val)
{
    pst_mac_vap_rom->st_wlan_mib_mu_edca.ast_wlan_mib_qap_edac[uc_index].en_dot11QAPEDCATableMandatory = uc_val;
}

OAL_STATIC OAL_INLINE oal_uint8 mac_mib_get_QAPMUEDCATableMandatory(
    mac_vap_rom_stru *pst_mac_vap_rom, oal_uint8 uc_index)
{
    return pst_mac_vap_rom->st_wlan_mib_mu_edca.ast_wlan_mib_qap_edac[uc_index].en_dot11QAPEDCATableMandatory;
}

OAL_STATIC OAL_INLINE oal_void mac_mib_set_PPEThresholdsRequired(mac_vap_rom_stru *pst_mac_vap_rom,
...
/* 10 函数声明 */
extern oal_uint32 mac_vap_init_etc(mac_vap_stru *pst_vap,
...
extern oal_void mac_vap_init_rates_by_protocol_etc(mac_vap_stru *pst_vap,
                                                   wlan_protocol_enum_uint8 en_vap_protocol,
                                                   mac_data_rate_stru *pst_rates);
...
extern oal_uint32 mac_vap_find_user_by_macaddr_etc(mac_vap_stru *pst_vap,
                                                   const unsigned char *puc_sta_mac_addr,
                                                   oal_uint16 *pus_user_idx);
extern oal_uint32 mac_device_find_user_by_macaddr_etc(oal_uint8 uc_device_id,
                                                      const unsigned char *puc_sta_mac_addr,
                                                      oal_uint16 *pus_user_idx);
extern oal_uint32 mac_chip_find_user_by_macaddr(oal_uint8 uc_chip_id,
                                                const unsigned char *puc_sta_mac_addr,
                                                oal_uint16 *pus_user_idx);
extern oal_uint32 mac_board_find_user_by_macaddr(const unsigned char *puc_sta_mac_addr,
                                                 oal_uint16 *pus_user_idx);
extern oal_uint32 mac_vap_add_assoc_user_etc(mac_vap_stru *pst_vap, oal_uint16 us_user_idx);

extern oal_uint8 mac_vap_get_bandwith(wlan_bw_cap_enum_uint8 en_dev_cap,
...
/*****************************************************************************
    mib操作函数
*****************************************************************************/
extern oal_uint32 mac_mib_get_beacon_period_etc(mac_vap_stru *pst_mac_vap,
                                                oal_uint8 *puc_len,
                                                oal_uint8 *puc_param);
extern oal_uint32 mac_mib_get_dtim_period_etc(mac_vap_stru *pst_mac_vap,
                                              oal_uint8 *puc_len,
                                              oal_uint8 *puc_param);
extern oal_uint32 mac_mib_get_bss_type_etc(mac_vap_stru *pst_mac_vap,
                                           oal_uint8 *puc_len,
                                           oal_uint8 *puc_param);
extern oal_uint32 mac_mib_get_ssid_etc(mac_vap_stru *pst_mac_vap, oal_uint8 *puc_len, oal_uint8 *puc_param);
extern oal_uint32 mac_mib_set_beacon_period_etc(mac_vap_stru *pst_mac_vap,
                                                oal_uint8 uc_len,
                                                oal_uint8 *puc_param);
extern oal_uint32 mac_mib_set_dtim_period_etc(mac_vap_stru *pst_mac_vap,
                                              oal_uint8 uc_len,
                                              oal_uint8 *puc_param);
extern oal_uint32 mac_mib_set_bss_type_etc(mac_vap_stru *pst_mac_vap,
                                           oal_uint8 uc_len,
                                           oal_uint8 *puc_param);
extern oal_uint32 mac_mib_set_ssid_etc(mac_vap_stru *pst_mac_vap, oal_uint8 uc_len, oal_uint8 *puc_param);
extern oal_uint32 mac_mib_set_station_id_etc(mac_vap_stru *pst_mac_vap,
                                             oal_uint8 uc_len,
                                             oal_uint8 *puc_param);
extern oal_uint32 mac_mib_get_shpreamble_etc(mac_vap_stru *pst_mac_vap,
                                             oal_uint8 *puc_len,
                                             oal_uint8 *puc_param);
extern oal_uint32 mac_mib_set_shpreamble_etc(mac_vap_stru *pst_mac_vap,
                                             oal_uint8 uc_len,
                                             oal_uint8 *puc_param);
extern oal_uint32 mac_vap_set_bssid_etc(mac_vap_stru *pst_mac_vap, oal_uint8 *puc_bssid);
extern oal_uint32 mac_vap_set_current_channel_etc(mac_vap_stru *pst_vap,
                                                  wlan_channel_band_enum_uint8 en_band,
...
#endif
extern oal_uint32 mac_vap_init_by_protocol_etc(mac_vap_stru *pst_mac_vap,
                                               wlan_protocol_enum_uint8 en_protocol);

extern oal_bool_enum_uint8 mac_vap_check_bss_cap_info_phy_ap_etc(oal_uint16 us_cap_info,
                                                                 mac_vap_stru *pst_mac_vap);
...
extern mac_wme_param_stru *mac_get_wmm_cfg_multi_user_multi_ac(
    oal_traffic_type_enum_uint8 en_vap_mode);
#endif
extern oal_void mac_vap_get_bandwidth_cap_etc(mac_vap_stru *pst_mac_vap,
                                              wlan_bw_cap_enum_uint8 *pen_cap);
extern oal_void mac_vap_change_mib_by_bandwidth_etc(mac_vap_stru *pst_mac_vap,
                                                    wlan_channel_band_enum_uint8 en_band,
                                                    wlan_channel_bandwidth_enum_uint8 en_bandwidth);
...
extern oal_uint8 mac_vap_get_ap_usr_opern_bandwidth(mac_vap_stru *pst_mac_sta,
                                                    mac_user_stru *pst_mac_user);
extern oal_uint32 mac_device_find_up_vap_etc_ram(mac_device_stru *pst_mac_device,
    mac_vap_stru **ppst_mac_vap);
extern oal_uint32 mac_vap_check_ap_usr_opern_bandwidth(mac_vap_stru *pst_mac_sta,
                                                       mac_user_stru *pst_mac_user);
extern oal_uint8 mac_vap_set_bw_check(mac_vap_stru *pst_mac_sta,
...
#ifdef _PRE_WLAN_FEATURE_STA_PM
extern oal_void mac_vap_set_uapsd_para_etc(mac_vap_stru *pst_mac_vap,
                                           mac_cfg_uapsd_sta_stru *pst_uapsd_info);
#endif
extern oal_void mac_vap_set_wmm_params_update_count_etc(mac_vap_stru *pst_vap,
                                                        oal_uint8 uc_update_count);
...
extern oal_uint32 mac_vap_save_app_ie_etc(mac_vap_stru *pst_mac_vap,
...
extern oal_uint32 mac_mib_set_wep_etc(mac_vap_stru *pst_mac_vap,
                                      oal_uint8 uc_key_id,
                                      oal_uint8 uc_key_value);
...
extern oal_uint32 mac_vap_add_key_etc(mac_vap_stru *pst_mac_vap, mac_user_stru *pst_mac_user,
...
extern wlan_prot_mode_enum_uint8 mac_vap_get_user_protection_mode_etc(mac_vap_stru *pst_mac_vap_sta,
                                                                      mac_user_stru *pst_mac_user);
extern oal_void mac_protection_set_rts_tx_param_etc(mac_vap_stru *pst_mac_vap,
...
extern oal_void mac_protection_set_lsig_txop_mechanism_etc(mac_vap_stru *pst_mac_vap,
                                                           oal_switch_enum_uint8 en_flag);

#ifdef _PRE_WLAN_FEATURE_VOWIFI
extern oal_uint32 mac_vap_set_vowifi_param_etc(mac_vap_stru *pst_mac_vap,
                                               mac_vowifi_cmd_enum_uint8 en_vowifi_cfg_cmd,
                                               oal_uint8 uc_value);
#endif /* _PRE_WLAN_FEATURE_VOWIFI */
extern oal_void mac_device_set_vap_id_etc(mac_device_stru *pst_mac_device, mac_vap_stru *pst_mac_vap,
...
extern mac_vap_stru *mac_device_find_another_up_vap_etc(mac_device_stru *pst_mac_device,
                                                        oal_uint8 uc_vap_id_self);
...
extern oal_uint32 mac_device_find_up_p2p_go_etc(mac_device_stru *pst_mac_device,
                                                mac_vap_stru **ppst_mac_vap);
extern oal_uint32 mac_device_get_up_vap_num(mac_device_stru *pst_mac_device);
extern oal_uint32 mac_device_find_2up_vap_etc(mac_device_stru *pst_mac_device,
...
extern oal_uint32 mac_device_find_smps_mode_en(mac_device_stru *pst_mac_device,
                                               wlan_mib_mimo_power_save_enum_uint8 en_smps_mode);
#endif
extern oal_void mac_device_set_channel_etc(mac_device_stru *pst_mac_device,
                                           mac_cfg_channel_param_stru *pst_channel_param);
extern oal_void mac_device_get_channel_etc(mac_device_stru *pst_mac_device,
                                           mac_cfg_channel_param_stru *pst_channel_param);
...
extern oal_void mac_blacklist_free_pointer(mac_vap_stru *pst_mac_vap,
...
extern oal_uint32 mac_vap_init_by_protocol_cb(mac_vap_stru *pst_mac_vap,
                                              wlan_protocol_enum_uint8 en_protocol);
...
extern oal_void mac_vap_init_11ac_mcs_singlenss_rom_cb(mac_vap_stru *pst_mac_vap,
                                                       wlan_channel_bandwidth_enum_uint8 en_bandwidth);
extern oal_void mac_vap_init_11ac_mcs_doublenss_rom_cb(mac_vap_stru *pst_mac_vap,
                                                       wlan_channel_bandwidth_enum_uint8 en_bandwidth);
extern oal_void mac_vap_ch_mib_by_bw_cb(mac_vap_stru *pst_mac_vap,
                                        wlan_channel_band_enum_uint8 en_band,
                                        wlan_channel_bandwidth_enum_uint8 en_bandwidth);
extern oal_void mac_vap_init_11ac_mcs_singlenss(mac_vap_stru *pst_mac_vap,
                                                wlan_channel_bandwidth_enum_uint8 en_bandwidth);
extern oal_uint32 mac_vap_add_wep_key(mac_vap_stru *pst_mac_vap, oal_uint8 us_key_idx,
                                      oal_uint8 uc_key_len, oal_uint8 *puc_key);
extern oal_void mac_vap_tx_data_set_user_htc_cap(mac_vap_stru *pst_mac_vap,
                                                 mac_user_stru *pst_mac_user);
#ifdef _PRE_WLAN_FEATURE_VOWIFI
...
extern mac_qos_enhance_sta_stru *mac_tx_find_qos_enhance_list(mac_vap_stru *pst_mac_vap,
                                                              oal_uint8 *puc_sta_member_addr);
#endif
#ifdef _PRE_WLAN_FEATURE_TWT
extern oal_uint32 mac_device_find_up_sta_wlan_etc(mac_device_stru *pst_mac_device,
                                                  mac_vap_stru **ppst_mac_vap);
#endif
extern oal_void mac_init_mib_etc(mac_vap_stru *pst_mac_vap);
extern oal_void mac_vap_free_mib_etc(mac_vap_stru *pst_vap);
extern mac_vap_stru *mac_vap_find_another_up_vap_by_mac_vap(mac_vap_stru *pst_vap);
extern oal_void mac_vap_csa_support_set(mac_vap_stru *pst_mac_vap, oal_bool_enum_uint8 en_cap);
extern oal_bool_enum_uint8 mac_vap_go_can_not_in_160M_check(mac_vap_stru *p_mac_vap,
    oal_uint8 vap_channel);
