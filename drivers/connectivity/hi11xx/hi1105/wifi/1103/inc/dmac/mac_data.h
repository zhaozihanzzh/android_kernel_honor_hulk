...
/* 4 全局变量声明 */
typedef oal_void (*data_type_from_8023)(oal_uint8 *puc_frame_hdr,
                                        mac_netbuff_payload_type uc_hdr_type,
                                        oal_uint8 *puc_datatype);
...
extern oal_uint8 mac_get_data_type_from_8023_etc(oal_uint8 *puc_frame_hdr,
                                                 mac_netbuff_payload_type uc_hdr_type);
oal_bool_enum_uint8 mac_is_eapol_key_ptk_etc(mac_eapol_header_stru *pst_eapol_header);
extern oal_uint8 mac_get_data_type_from_80211_etc(oal_netbuf_stru *pst_netbuff,
                                                  oal_uint16 us_mac_hdr_len);
...
extern oal_bool_enum_uint8 mac_dhcp_frame_should_drop(oal_uint8 *puc_frame_hdr,
                                                      wlan_vap_mode_enum_uint8 mode);
#endif
extern pkt_trace_type_enum_uint8 mac_pkt_should_trace(oal_uint8 *puc_frame_hdr,
                                                      mac_netbuff_payload_type uc_hdr_type);
