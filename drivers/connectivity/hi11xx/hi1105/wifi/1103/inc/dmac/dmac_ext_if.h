...
/* 抛往dmac侧消息头的长度 */
#define CUSTOM_MSG_DATA_HDR_LEN (OAL_SIZEOF(custom_cfgid_enum_uint32) + OAL_SIZEOF(oal_uint32))
...
struct mac_tx_ctl {
    ...
    oal_uint8 bit_is_himit : 1; /* 用于标记himit帧 */
    oal_uint8 bit_hiex_traced : 1; /* 用于标记hiex帧 */
    oal_uint8 bit_is_game_marked : 1; /* 用于标记游戏帧 */
    oal_uint8 uc_reserved1 : 4;
...
typedef struct {
    ...
    oal_uint8  auc_resv[1];
    oal_uint16 us_conus_enq_cnt;       /* TID连续入队没有出队次数 */
#else
    oal_uint16 us_conus_enq_cnt;
    oal_uint16 us_resv;
#endif
#ifdef _PRE_WLAN_FEATURE_11AX
    oal_uint16 us_last_schedule_timestamp; /* 该tid上一次被调度时间 */
    oal_uint16 us_resv2;
#endif
...
typedef struct {
    oal_uint8 uc_fem_delt_pow;
    oal_uint8 uc_tpc_adj_pow_start_idx;
    oal_uint8 auc_resv[2];
...
/* 8 UNION定义 */
/* 9 OTHERS定义 */
/* 只取头的长度，去掉4字节auc_msg_body长度 */
#define HMAC_TO_DMAC_CFG_MSG_HDR_LEN (OAL_SIZEOF(hmac_to_dmac_cfg_msg_stru) - 4)
...
#define MAC_GET_CB_SEQ_NUM(_pst_tx_ctrl)             \
    (((mac_ieee80211_frame_stru *)((oal_uint8 *)_pst_tx_ctrl + OAL_MAX_CB_LEN))->bit_seq_num)
...
#define MAC_GET_CB_FRAME_HEADER_ADDR(_pst_tx_ctrl) \
    ((mac_ieee80211_frame_stru *)((oal_uint8 *)_pst_tx_ctrl + OAL_MAX_CB_LEN))
...
OAL_STATIC OAL_INLINE oal_uint32 dmac_rx_free_netbuf_list(oal_netbuf_head_stru *pst_netbuf_hdr,
                                                          ...
                                                          oal_uint16 us_nums)
{
    ...
    if (OAL_UNLIKELY((pst_netbuf_hdr == OAL_PTR_NULL) || (pst_netbuf == OAL_PTR_NULL))) {
...
#endif
#endif
extern oal_uint32 dmac_tx_reinit_tx_queue(mac_device_stru *pst_mac_device,
    hal_to_dmac_device_stru *pst_hal_device);
extern oal_uint32 mac_vap_set_cb_tx_user_idx(mac_vap_stru *pst_mac_vap,
    mac_tx_ctl_stru *pst_tx_ctl, const unsigned char *puc_data);

extern oal_void dmac_tid_tx_queue_init_cb(dmac_tid_stru *past_tx_tid_queue,
    mac_user_stru *pst_user, oal_uint32 *pul_result);

#ifdef _PRE_WLAN_FEATURE_HIEX
#ifdef IS_DEVICE
extern oal_uint32 dmac_hiex_get_timestamp(mac_vap_stru *vap);
#endif
#endif
