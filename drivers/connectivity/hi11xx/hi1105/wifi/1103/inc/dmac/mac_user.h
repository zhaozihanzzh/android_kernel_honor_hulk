...
typedef struct {
    oal_uint32 bit_spectrum_mgmt : 1, /* 频谱管理: 0=不支持, 1=支持 */
               ...
               bit_dcm_cap : 1,
               bit_support_he_cap : 1,  /* Support 11ax 协议 */
...
typedef struct {
    ...
    oal_uint8 bit_no_short_slot_stats_flag : 1;
...
typedef struct {
    ...
    oal_uint8 auc_he_hdl_rom_rsv5[2];
#endif

    oal_uint8 auc_alg_priv_cap[WLAN_WME_AC_BUTT];
...
#define MAC_USER_GET_HIEX_CAP(user)     (&(((mac_user_rom_stru*)((user)->_rom))->st_hiex_cap))
#define MAC_USER_HIEX_ENABLED(user)     (((mac_user_rom_stru*)((user)->_rom))->st_hiex_cap.bit_hiex_enable)
#define MAC_USER_HIMIT_ENABLED(user)    (((mac_user_rom_stru*)((user)->_rom))->st_hiex_cap.bit_himit_enable)
#endif
...
OAL_STATIC OAL_INLINE oal_void mac_user_del_ra_lut_index(oal_uint8 *puc_index_table,
...
/* 10 函数声明 */
oal_uint32 mac_user_add_wep_key_etc(mac_user_stru *pst_mac_user, oal_uint8 uc_key_index,
                                    mac_key_params_stru *pst_key);
oal_uint32 mac_user_add_rsn_key_etc(mac_user_stru *pst_mac_user, oal_uint8 uc_key_index,
                                    mac_key_params_stru *pst_key);
oal_uint32 mac_user_add_bip_key_etc(mac_user_stru *pst_mac_user, oal_uint8 uc_key_index,
                                    mac_key_params_stru *pst_key);
extern wlan_priv_key_param_stru *mac_user_get_key_etc(mac_user_stru *pst_mac_user, oal_uint8 uc_key_id);

extern oal_uint32 mac_user_init_etc(mac_user_stru *pst_mac_user,
                                    oal_uint16 us_user_idx,
                                    oal_uint8 *puc_mac_addr,
                                    oal_uint8 uc_chip_id,
                                    oal_uint8 uc_device_id,
...
extern oal_void mac_user_avail_bf_num_spatial_stream_etc(mac_user_stru *pst_mac_user,
                                                         oal_uint8 uc_value);
extern oal_void mac_user_set_avail_num_spatial_stream_etc(mac_user_stru *pst_mac_user,
                                                          oal_uint8 uc_value);
extern oal_void mac_user_set_num_spatial_stream_etc(mac_user_stru *pst_mac_user, oal_uint8 uc_value);
extern oal_void mac_user_set_bandwidth_cap_etc(mac_user_stru *pst_mac_user,
...
extern oal_void mac_user_get_sta_cap_bandwidth_etc(mac_user_stru *pst_mac_user,
...
extern oal_void mac_user_set_avail_protocol_mode_etc(mac_user_stru *pst_mac_user,
                                                     wlan_protocol_enum_uint8 en_avail_protocol_mode);
extern oal_void mac_user_set_cur_protocol_mode_etc(mac_user_stru *pst_mac_user,
                                                   wlan_protocol_enum_uint8 en_cur_protocol_mode);
extern oal_void mac_user_set_cur_bandwidth_etc(mac_user_stru *pst_mac_user,
                                               wlan_bw_cap_enum_uint8 en_cur_bandwidth);
extern oal_void mac_user_set_protocol_mode_etc(mac_user_stru *pst_mac_user,
                                               wlan_protocol_enum_uint8 en_protocol_mode);
extern oal_void mac_user_set_asoc_state_etc(mac_user_stru *pst_mac_user,
                                            mac_user_asoc_state_enum_uint8 en_value);
extern oal_void mac_user_set_avail_op_rates_etc(mac_user_stru *pst_mac_user, oal_uint8 uc_rs_nrates,
...
extern oal_void mac_user_set_ht_capable_etc(mac_user_stru *pst_mac_user,
...
#endif
extern oal_void mac_user_set_pmf_active_etc(mac_user_stru *pst_mac_user,
                                            oal_bool_enum_uint8 en_pmf_active);
extern oal_void mac_user_set_barker_preamble_mode_etc(mac_user_stru *pst_mac_user,
...
extern oal_void mac_user_set_spectrum_mgmt_etc(mac_user_stru *pst_mac_user,
...
extern oal_void mac_user_set_num_spatial_stream_160M(mac_user_stru *pst_mac_user,
    oal_uint8 uc_value);
...
extern oal_bool_enum_uint8 mac_user_get_port_etc(mac_user_stru *mac_user);
