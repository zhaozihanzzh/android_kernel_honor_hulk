...
/* MODEM命令使用，期望切换状态 */
typedef enum {
    MAC_M2S_MODEM_STATE_SISO_C0     = 0,
    MAC_M2S_MODEM_STATE_MIMO        = 2,

    MAC_M2S_MODEM_STATE_BUTT,
} mac_m2s_modem_state_enum;
typedef oal_uint8 mac_m2s_modem_state_enum_uint8;
...
typedef struct {
    ...
    oal_uint8 bit_roc_type_tx_mgmt : 1;             /* remain on channel类型是否为发送管理帧 */
    oal_uint8 bit_rsv : 2;                          /* 保留位 */
...
typedef struct {
    ...
    oal_uint32 ul_off_chan_cac_outof_5600_to_5650_time_ms;
    /* Off-Channel CAC检测时长，5600MHz ~ 5650MHz频段内，默认60分钟 */
    oal_uint32 ul_off_chan_cac_in_5600_to_5650_time_ms;
...
#endif
    oal_uint16 us_cmd_auth_rsp_timeout;
    oal_uint8  bit_forbit_open_auth : 1,
               bit_rsv              : 7;
    oal_uint8  auc_rsv[1];
...
typedef struct {
    ...
    union {
        ...
        struct {
            mac_m2s_modem_state_enum_uint8    en_m2s_state;   /* 期望切换到状态 */
        } modem_mode;
    } pri_data;
} mac_m2s_mgr_stru;
...
typedef struct {
    ...
    oal_uint8 uc_cfg_preempt_mode;
    /* 0 noframe 1 self-cts 2 nulldata 3 qosnull  0/1 软件ps打开或者关闭 */
    oal_uint8 uc_cfg_preempt_type;
...
typedef struct {
    ...
    oal_uint8 auc_vap_id[WLAN_SERVICE_VAP_MAX_NUM_PER_DEVICE];
    ...
    oal_uint32 ul_hiex_debug_switch;
#else
    oal_uint32 ul_resv1;
    oal_uint32 ul_resv2;
#endif
...
typedef struct {
    ...
    /* 接收端BA LUT 是否在 hal BA LUT寄存器里 1: 表示在  0: 表示不在 当前已被置换出去 */
    oal_uint8 auc_rx_ba_lut_idx_status_table[MAC_RX_BA_LUT_BMAP_LEN];
#endif
...
typedef struct {
    ...
    /* hal硬件BA index 和 软件ba index的映射关系表 随着实际BA替换过程改变 */
    oal_uint8 auc_hal_to_dmac_lut_index_map[WLAN_MAX_RX_BA];
...
extern oal_uint32 mac_device_init_etc(mac_device_stru *pst_mac_device, oal_uint32 ul_chip_ver,
                                      oal_uint8 chip_id, oal_uint8 uc_device_id);
...
extern oal_void mac_blacklist_get_pointer(wlan_vap_mode_enum_uint8 en_vap_mode, oal_uint8 uc_dev_id,
                                          oal_uint8 uc_chip_id, oal_uint8 uc_vap_id,
...
extern oal_void mac_dfs_set_cac_time(mac_device_stru *pst_mac_device, oal_uint32 ul_time_ms,
                                     oal_bool_enum_uint8 en_waether);
extern oal_void mac_dfs_set_off_cac_time(mac_device_stru *pst_mac_device, oal_uint32 ul_time_ms,
                                         oal_bool_enum_uint8 en_waether);
...
extern oal_void mac_dfs_set_next_radar_ch(mac_device_stru *pst_mac_device, oal_uint8 uc_ch,
...
extern oal_uint32 g_ul_ddr_freq;
...
OAL_STATIC OAL_INLINE oal_bool_enum_uint8 mac_device_is_auto_chan_sel_enabled(mac_device_stru *pst_mac_device)
{
    ...
    if (pst_mac_device->uc_max_channel == 0) {
        return OAL_TRUE;
    }
...
extern wlan_mib_vht_supp_width_enum_uint8 mac_device_trans_bandwith_to_vht_capinfo(wlan_bw_cap_enum_uint8 en_max_op_bd);
...
#ifdef _PRE_WLAN_FEATURE_11AX
OAL_STATIC OAL_INLINE oal_bool_enum_uint8 mac_device_twt_custom_is_open(oal_void)
{
    return (g_st_mac_device_custom_cfg.st_11ax_custom_cfg.bit_twt_responder_support ||
