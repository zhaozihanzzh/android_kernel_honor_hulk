...
typedef oal_bool_enum (*p_mac_regdomain_channel_is_support_bw_cb)(wlan_channel_bandwidth_enum_uint8 en_cfg_bw,
...
extern oal_uint32 mac_get_channel_num_from_idx_etc(oal_uint8 uc_band,
                                                   oal_uint8 uc_idx,
                                                   oal_uint8 *puc_channel_num);
extern oal_uint32 mac_get_channel_idx_from_num_etc(oal_uint8 uc_band,
...
extern oal_uint32 mac_set_country_ie_2g_etc(mac_regdomain_info_stru *pst_rd_info,
                                            oal_uint8 *puc_buffer,
                                            oal_uint8 *puc_len);

extern oal_uint32 mac_set_country_ie_5g_etc(mac_regdomain_info_stru *pst_rd_info,
                                            oal_uint8 *puc_buffer,
                                            oal_uint8 *puc_len);
#endif
...
extern oal_void mac_get_ext_chan_info(oal_uint8 uc_pri20_channel_idx,
                                      wlan_channel_bandwidth_enum_uint8 en_bandwidth,
                                      mac_channel_list_stru *pst_chan_info);
extern oal_bool_enum_uint8 mac_is_cover_dfs_channel(oal_uint8 uc_band,
                                                    wlan_channel_bandwidth_enum_uint8 en_bandwidth,
                                                    oal_uint8 uc_channel_num);
extern wlan_channel_bandwidth_enum_uint8 mac_regdomain_get_support_bw_mode(
    wlan_channel_bandwidth_enum_uint8 en_chan_width, oal_uint8 uc_channel);
oal_bool_enum mac_regdomain_channel_is_support_bw(wlan_channel_bandwidth_enum_uint8 en_cfg_bw, oal_uint8 uc_channel);
wlan_channel_bandwidth_enum_uint8 mac_regdomain_get_bw_by_channel_bw_cap(oal_uint8 uc_channel,
