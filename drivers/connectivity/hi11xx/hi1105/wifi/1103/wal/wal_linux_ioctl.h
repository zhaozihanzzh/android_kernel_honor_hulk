...
extern oal_int8 g_wait_wlan_power_on_cali;
...
typedef struct wal_wifi_pc_cmd {
    oal_int32   l_verify;    /* 校验位 */
    oal_uint32  ul_cmd;      /* 命令号 */
...
extern oal_int32 wal_regdomain_update_country_code_etc(oal_net_device_stru *pst_net_dev, oal_int8 *pc_country);
#ifdef _PRE_WLAN_COUNTRYCODE_SELFSTUDY
extern oal_int32 wal_regdomain_update_selfstudy_country_code_etc(oal_net_device_stru *pst_net_dev,
                                                                 oal_int8 *pc_country);
extern oal_void wal_selfstudy_regdomain_update_by_ap_etc(frw_event_stru *pst_event);
#endif
#endif
...
extern oal_int32 wlan_enter_light_suspend(void);
extern oal_int32 wlan_exit_light_suspend(void);
extern oal_void wal_register_lights_suspend(void);
extern oal_void wal_unregister_lights_suspend(void);
...
extern oal_uint32 wal_hipriv_set_mcast_data_dscr_param(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param);
