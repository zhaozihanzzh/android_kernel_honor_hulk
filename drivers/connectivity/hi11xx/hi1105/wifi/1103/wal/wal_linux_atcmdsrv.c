...
OAL_STATIC oal_int32 wal_atcmsrv_adapt_mode(oal_net_device_stru *pst_net_dev,
    mac_cfg_mode_param_stru *pst_mode_param, oal_int32 l_mode)
{
    oal_int8  *mcast_data = "cc 1";
...
OAL_STATIC oal_int32 wal_hipriv_protocol_set_mcs_etc(oal_net_device_stru *pst_net_dev, oal_uint8 uc_prot_idx)
{
    oal_uint32 ul_ret = 0;
                                                    ...
                                                    wal_atcmdsrv_wifi_priv_cmd_stru *pst_priv_cmd)
{
    ...
    ul_ret = wal_hipriv_protocol_set_mcs_etc(pst_net_dev, uc_prot_idx);
...
oal_int32 wal_atcmdsrv_wifi_priv_cmd_etc(oal_net_device_stru *pst_net_dev, oal_ifreq_stru *pst_ifr, oal_int32 ul_cmd)
{
    ...
    OAM_ERROR_LOG1(0, 0, "wal_atcmdsrv_wifi_priv_cmd_etc::p_func not register, cmd_idx is %d", uc_i);
    return -OAL_EINVAL;
}
#endif
