...
OAL_STATIC oal_uint32 wal_config_enable_rr_time_info(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param)
{
...
OAL_STATIC oal_uint32  wal_config_set_user_hiex_enable(mac_vap_stru *pst_mac_vap, oal_uint16 us_len,
    oal_uint8 *puc_param)
{
