                                                ...
                                                mac_frame_he_spatial_reuse_parameter_set_ie_stru *pst_he_srp_value)
{
    ...
    if (pst_he_sr_control->bit_non_srg_offset_present == 1) {
        ...
        pst_he_srp_value->uc_non_srg_obss_pd_max_offset = *puc_he_buffer;
        puc_he_buffer += 1;
    }

    if (pst_he_sr_control->bit_srg_information_present == 1) {
        /* SRG OBSS PD Min Offset */
        pst_he_srp_value->uc_srg_obss_pd_min_offset = *puc_he_buffer;
        puc_he_buffer += 1;

        /* SRG OBSS PD Max Offset */
        pst_he_srp_value->uc_srg_obss_pd_max_offset = *puc_he_buffer;
        puc_he_buffer += 1;
...
oal_uint32 mac_ie_parse_multi_bssid_opt_subie(oal_uint8 *puc_frame_data,
    mac_multi_bssid_frame_info_stru *pst_mbssid_frame_info, oal_uint8 *puc_mbssid_body_ie_len)
{
    ...
    ***************************************************************************/
    ...
    pst_mbssid_frame_info->us_non_tramsmitted_bssid_cap =
        *(oal_uint16 *)(puc_non_transmitted_bssid_cap + MAC_IE_HDR_LEN);
...
oal_uint16 mac_ie_get_max_mpdu_len_by_vht_cap(oal_uint8 uc_vht_cap_max_mpdu_len_bit)
{
    oal_uint16 us_max_mpdu_length = 3895;

    if (uc_vht_cap_max_mpdu_len_bit == 0) {
        us_max_mpdu_length = 3895;
    } else if (uc_vht_cap_max_mpdu_len_bit == 1) {
        us_max_mpdu_length = 7991;
    } else if (uc_vht_cap_max_mpdu_len_bit == 2) {
    ...
    mac_user_stru *pst_mac_user, mac_opmode_notify_stru *pst_opmode_notify, oal_bool_enum_uint8 en_from_beacon)
{
    ...
    if (en_avail_nss != pst_mac_user->en_avail_num_spatial_stream) {
        ...
        OAM_WARNING_LOG4(pst_mac_vap->uc_vap_id, OAM_SF_OPMODE,
            ...
            pst_opmode_notify->bit_rx_nss, mac_user_get_smps_opmode_notify_nss(pst_mac_user));
    }
