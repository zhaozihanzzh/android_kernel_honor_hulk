...
/* stream info item */
typedef struct {
    oal_uint32  server_ip;    /* all net endian */
    oal_uint32  client_ip;
    oal_uint16  server_port;
    oal_uint16  client_port;
    oal_uint32  mark;         /* used for game/voice... */
    oal_uint32  last_active;
} hmac_hiex_sii_stru;
...
extern mac_ap_type_enum_uint16 hmac_compability_ap_tpye_identify_etc(mac_vap_stru *pst_mac_vap,
                                                                     oal_uint8 *puc_mac_addr);
extern oal_void hmac_user_set_amsdu_level_by_max_mpdu_len(hmac_user_stru *pst_hmac_user,
    oal_uint16 us_max_mpdu_len);
extern oal_void hmac_user_set_amsdu_level(hmac_user_stru *pst_hmac_user,
...
#endif
extern oal_void hmac_user_cap_update_by_hisi_cap_ie(hmac_user_stru *pst_hmac_user,
    oal_uint8 *puc_payload, oal_uint32 ul_msg_len);
extern oal_void hmac_user_set_close_ht_flag(mac_vap_stru *p_mac_vap, hmac_user_stru *p_hmac_user);
