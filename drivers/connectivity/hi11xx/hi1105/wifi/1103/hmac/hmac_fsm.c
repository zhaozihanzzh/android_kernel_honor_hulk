...
OAL_STATIC oal_void hmac_fsm_init_sta_listen_req(oal_void)
{
    oal_uint32 ul_state;
    ...
    if (hmac_get_feature_switch(HMAC_MIRACAST_SINK_SWITCH)) {
        g_pa_hmac_sta_fsm_func[MAC_VAP_STATE_INIT][HMAC_FSM_INPUT_LISTEN_REQ] = hmac_p2p_remain_on_channel_etc;
    }
