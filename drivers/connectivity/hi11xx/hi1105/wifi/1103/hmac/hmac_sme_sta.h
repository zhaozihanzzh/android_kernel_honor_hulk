...
OAL_STATIC OAL_INLINE void hmac_cfg80211_output_ret_log(mac_vap_stru *pst_mac_vap,
    oal_uint32 ul_ret, oal_uint8 uc_band, oal_uint8 uc_channel_number)
{
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG2(pst_mac_vap->uc_vap_id, OAM_SF_SCAN,
            "{hmac_cfg80211_prepare_scan_req_sta::WLAN_BAND:%d, mac_get_channel_idx_from_num_etc fail. chan_number:%u}",
