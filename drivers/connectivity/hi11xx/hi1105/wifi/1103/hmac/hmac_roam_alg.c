...
OAL_STATIC void hmac_roam_alg_record_bss_info_etc(hmac_roam_record_stru *pst_roam_record,
...
OAL_STATIC void hmac_roam_alg_record_bss_etc(hmac_roam_alg_stru *pst_roam_alg, mac_bss_dscr_stru *pst_bss_dscr)
{
    if (pst_bss_dscr->st_channel.en_band == WLAN_BAND_5G) {
...
oal_uint32 hmac_roam_alg_bss_in_ess_etc(hmac_roam_info_stru *pst_roam_info, mac_bss_dscr_stru *pst_bss_dscr)
{
    ...
    roam_timeout = ((g_pd_bss_expire_time_etc * 1000) < HMAC_SCAN_MAX_VALID_SCANNED_BSS_EXPIRE) ?  /* 1000 ms */
        HMAC_SCAN_MAX_VALID_SCANNED_BSS_EXPIRE : (g_pd_bss_expire_time_etc * 1000); /* 1000 ms */
    ...
    hmac_roam_alg_record_bss_etc(pst_roam_alg, pst_bss_dscr);
...
OAL_STATIC oal_uint32 hmac_roam_alg_check_aging_time(hmac_roam_info_stru *pst_roam_info,
                                                     mac_bss_dscr_stru *pst_bss_dscr)
{
    hmac_vap_stru *pst_hmac_vap;
    oal_uint32 roam_timeout;
