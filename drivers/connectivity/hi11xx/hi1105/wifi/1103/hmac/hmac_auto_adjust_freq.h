...
typedef struct {
    ...
    oal_uint8 uc_req_super_cpu_freq;            /* 期望CPU超频 */
    oal_uint8 uc_cur_cpu_freq_state;
    oal_uint16 us_lock_cpu_th_high;
    oal_uint16 us_lock_cpu_th_low;
    oal_uint16 dma_latency_value;
