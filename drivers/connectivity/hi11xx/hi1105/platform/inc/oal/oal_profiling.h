...
typedef struct {
    ...
    oal_uint64 tx_w2hmac_timestamp;
    oal_uint64 tx_hmac2d_timestamp;
    oal_uint64 rx_hmac2w_timestamp;
    oal_uint64 rx_d2hmac_timestamp;
} oal_perform_host_timestamp_t;

extern oal_perform_host_timestamp_t g_host_rr_perform_timestamp;
#endif
...
#ifdef _PRE_WLAN_RR_PERFORMENCE_DEBUG
extern oal_void oal_profiling_rr_perform_timestamp_init(oal_void);
#endif
