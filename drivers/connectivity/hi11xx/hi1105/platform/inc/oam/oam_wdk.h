...
typedef enum {
    ...
    OAM_FILE_ID_HMAC_WIFI6_SELF_CURE_C = 1424,
    OAM_FILE_ID_HMAC_WIFI6_SELF_CURE_H = 1425,
    OAM_FILE_ID_HMAC_HT_SELF_CURE_C = 1426,
    OAM_FILE_ID_HMAC_HT_SELF_CURE_H = 1427,
    ...
    OAM_FILE_ID_DMAC_TX_QOS_ENHANCE_C = 2803,
    OAM_FILE_ID_DMAC_TX_QOS_ENHANCE_H = 2804,
#endif
#ifdef _PRE_WLAN_FEATURE_APF
