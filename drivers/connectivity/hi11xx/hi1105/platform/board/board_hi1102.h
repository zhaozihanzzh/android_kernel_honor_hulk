...
/* 函数声明 */
extern int32 hi1102_get_board_power_gpio(struct platform_device *pdev);
extern void hi1102_free_board_power_gpio_etc(struct platform_device *pdev);
extern int32 hi1102_board_wakeup_gpio_init_etc(struct platform_device *pdev);
extern void hi1102_free_board_wakeup_gpio_etc(struct platform_device *pdev);
