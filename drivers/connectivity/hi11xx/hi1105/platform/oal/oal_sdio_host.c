...
OAL_STATIC oal_int32 oal_sdio_hcc_bus_power_down(
...
OAL_STATIC oal_int32 oal_sdio_hcc_bus_sw_power_down(
                     hcc_bus *pst_bus, struct oal_sdio *hi_sdio)
{
...
OAL_STATIC oal_int32 oal_sdio_hcc_bus_power_patch_lauch(hcc_bus *pst_bus)
{
...
OAL_STATIC oal_int32 oal_sdio_hcc_bus_sw_power_patch_lauch(
    hcc_bus *pst_bus, struct oal_sdio *hi_sdio)
{
...
OAL_STATIC oal_int32 oal_sdio_mmc_power_reinit(struct oal_sdio *hi_sdio)
{
    oal_int32 ret = OAL_SUCC;
...
OAL_STATIC oal_int32 oal_sdio_dev_reinit(struct oal_sdio *hi_sdio)
{
    oal_int32 ret = OAL_SUCC;
