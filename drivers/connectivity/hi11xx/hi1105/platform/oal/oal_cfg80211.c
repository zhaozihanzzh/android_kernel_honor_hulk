...
/*
 * 函 数 名  : oal_cfg80211_ch_switch_notify_etc
 * 功能描述  : 上报内核ch_switch 事件
 */
void oal_cfg80211_ch_switch_notify_etc(oal_net_device_stru *pst_netdev,
...
oal_module_symbol(oal_cfg80211_ch_switch_notify_etc);
