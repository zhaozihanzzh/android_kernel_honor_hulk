...
oal_int32 oal_pcie_set_device_aspm_dync_disable(oal_pcie_res *pst_pci_res, oal_uint32 disable)
{
    oal_uint32 value = 0;
    oal_int32 ret = oal_pcie_write_dsm32(pst_pci_res, PCIE_SHARED_ASPM_DYNC_CTL, disable);
...
oal_void oal_pcie_device_xfer_pending_sig_clr(oal_pcie_res *pst_pci_res, oal_bool_enum clear)
{
    oal_uint32 value;
    if (clear != 0) {
                                 ...
                                 oal_uint32 cpu_address, oal_uint32 length)
{
    ...
    if (index) {
        ...
        ret = oal_kernel_file_write_etc(fp, pst_buf, length);
        if (ret < 0) {
