...
/*****************************************************************************
  9 OTHERS定义
*****************************************************************************/
extern dcxo_manage_stru dcxo_info_etc;

/*****************************************************************************
  10 函数声明
*****************************************************************************/
extern oal_int32 dcxo_data_buf_malloc_etc(oal_void);
extern void dcxo_data_buf_free_etc(void);
extern oal_void *get_dcxo_data_buf_addr_etc(oal_void);
extern void read_tcxo_dcxo_ini_file_etc(void);
extern oal_void update_dcxo_coeff_etc(oal_int32 *coeff, oal_uint32 coeff_cnt);
extern oal_int32 read_dcxo_cali_data_etc(oal_void);
