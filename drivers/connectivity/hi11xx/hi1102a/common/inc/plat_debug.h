...
#define PS_PRINT_FUNCTION_NAME                                    \
    do {                                                          \
        if (PLAT_LOG_DEBUG <= plat_loglevel) {                  \
...
#define PS_PRINT_INFO(s, args...)                                           \
    do {                                                                    \
        if (PLAT_LOG_INFO <= plat_loglevel) {                             \
...
#define PS_PRINT_WARNING(s, args...)                                          \
    do {                                                                      \
        if (PLAT_LOG_WARNING <= plat_loglevel) {                            \
...
#define PS_PRINT_ALERT(s, args...)                                              \
    do {                                                                        \
        if (PLAT_LOG_ALERT <= plat_loglevel) {                                \
