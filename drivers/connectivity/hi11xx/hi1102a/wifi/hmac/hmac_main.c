...
OAL_STATIC oal_void hmac_event_fsm_dfs_tx_adapt_subtable_register(oal_void)
{
    ...
    dmac_wlan_ctx_event_sub_table[DMAC_WLAN_CTX_EVENT_SUB_TYPR_SWITCH_TO_OFF_CHAN].p_tx_adapt_func =
        hmac_hcc_tx_convert_event_to_netbuf_uint16;
    dmac_wlan_ctx_event_sub_table[DMAC_WLAN_CTX_EVENT_SUB_TYPR_SWITCH_TO_HOME_CHAN].p_tx_adapt_func =
        hmac_hcc_tx_convert_event_to_netbuf_uint16;
#endif
    dmac_wlan_ctx_event_sub_table[DMAC_WLAN_CTX_EVENT_SUB_TYPR_DFS_TEST].p_tx_adapt_func =
        hmac_hcc_tx_convert_event_to_netbuf_uint16;
#endif
}
...
OAL_STATIC oal_void hmac_event_fsm_tx_adapt_subtable1_register(oal_void)
{
    ...
    dmac_wlan_ctx_event_sub_table[DMAC_WLAN_CTX_EVENT_SUB_TYPE_DPD_DATA_PROCESSED].p_tx_adapt_func =
...
OAL_STATIC oal_uint32 hmac_flowctl_backp_event(frw_event_mem_stru *pst_event_mem)
{
    ...
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(pst_mac_vap->uc_vap_id, OAM_SF_ANY, "{hmac_flowctl_backp_event::dispatch_event fail}",
                         ul_ret);
        return ul_ret;
    }
