    ...
    dmac_query_station_info_response_event *pst_rsp_event)
{
    ...
    uc_flag |=
    ((pst_rsp_event->rate_info.txrx_rate.tx_rate.flags & MAC_RATE_INFO_FLAGS_MCS) ? RATE_INFO_FLAGS_MCS : 0);
    uc_flag |=
    ((pst_rsp_event->rate_info.txrx_rate.tx_rate.flags & MAC_RATE_INFO_FLAGS_VHT_MCS) ? RATE_INFO_FLAGS_VHT_MCS : 0);
    uc_flag |=
    ((pst_rsp_event->rate_info.txrx_rate.tx_rate.flags & MAC_RATE_INFO_FLAGS_SHORT_GI) ? RATE_INFO_FLAGS_SHORT_GI : 0);
    uc_flag |=
    ...
    pst_hmac_vap->station_info.txrate.bw =
        ...
        (pst_rsp_event->rate_info.txrx_rate.tx_rate.flags & MAC_RATE_INFO_FLAGS_160_MHZ_WIDTH ?
 ...
 */
        ...
        ((pst_rsp_event->rate_info.txrx_rate.tx_rate.flags & MAC_RATE_INFO_FLAGS_MCS) ? RATE_INFO_FLAGS_MCS : 0);
        uc_flag |=
        ((pst_rsp_event->rate_info.txrx_rate.tx_rate.flags & MAC_RATE_INFO_FLAGS_40_MHZ_WIDTH) ?
        RATE_INFO_FLAGS_40_MHZ_WIDTH : 0);
        uc_flag |=
        ((pst_rsp_event->rate_info.txrx_rate.tx_rate.flags & MAC_RATE_INFO_FLAGS_SHORT_GI) ?
...
#else
        uc_flag |= hmac_proc_query_response_flag(pst_hmac_vap, pst_rsp_event);
#endif
