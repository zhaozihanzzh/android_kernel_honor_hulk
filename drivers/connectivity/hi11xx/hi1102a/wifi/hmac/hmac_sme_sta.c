                                      ...
                                      oal_int32 l_idx, oal_survey_info_stru *pst_info)
{
    ...
    pst_info->time          = pst_rcd[l_idx].ul_total_stats_time_us / 1000;
    pst_info->time_busy     = (pst_rcd[l_idx].ul_total_stats_time_us -
                               pst_rcd[l_idx].ul_total_free_time_20M_us) / 1000;
    pst_info->time_ext_busy = 0;
    pst_info->time_rx = pst_rcd[l_idx].ul_total_recv_time_us / 1000;
    pst_info->time_tx = pst_rcd[l_idx].ul_total_send_time_us / 1000;

    pst_info->filled = SURVEY_INFO_TIME | SURVEY_INFO_TIME_BUSY | SURVEY_INFO_TIME_RX | SURVEY_INFO_TIME_TX;
#else
    pst_info->channel_time          = pst_rcd[l_idx].ul_total_stats_time_us / 1000;
    pst_info->channel_time_busy     = (pst_rcd[l_idx].ul_total_stats_time_us -
                                       pst_rcd[l_idx].ul_total_free_time_20M_us) / 1000;
    pst_info->channel_time_ext_busy = 0;
    pst_info->channel_time_rx = pst_rcd[l_idx].ul_total_recv_time_us / 1000;
    pst_info->channel_time_tx = pst_rcd[l_idx].ul_total_send_time_us / 1000;
