                                   ...
                                   oal_netbuf_stru *pst_netbuf)
{
    ...
    st_req_info.st_request_mode.bit_candidate_list_include = puc_data[3] & BIT0;
    st_req_info.st_request_mode.bit_abridged = (puc_data[3] & BIT1) ? OAL_TRUE : OAL_FALSE;
    ...
    st_req_info.uc_validity_interval = puc_data[6];
