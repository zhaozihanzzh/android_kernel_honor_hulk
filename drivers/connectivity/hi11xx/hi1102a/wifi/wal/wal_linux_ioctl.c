...
OAL_STATIC oal_void wal_event_report_to_sdt(
    wal_msg_type_enum_uint8 en_msg_type, oal_uint8 *puc_param, wal_msg_stru *pst_cfg_msg);
#endif
#endif
...
OAL_STATIC oal_int32 wal_finish_spe_rd(
    oal_int32 l_port_num, oal_int32 l_src_port_num, oal_netbuf_stru *pst_buf, oal_uint32 ul_dma, oal_uint32 ul_flags);
...
#ifdef _PRE_WLAN_FEATURE_GREEN_AP
    /* green AP开关: hipriv "wlan0 green_ap_en 0 | 1" */
    { "green_ap_en", wal_hipriv_green_ap_en },
#endif
#ifdef _PRE_WLAN_FEATURE_IP_FILTER
    /*
                             ...
                             wal_msg_stru **ppst_rsp_msg)
{
    ...
    ***************************************************************************/
    ...
    l_ret = OAL_WAIT_EVENT_TIMEOUT(g_wal_wid_msg_queue.st_wait_queue,
        OAL_TRUE == wal_request_wait_event_condition(&st_msg_request), 30 * OAL_TIME_HZ);
    /*lint +e730*/
...
OAL_STATIC oal_int32 hwifi_config_host_global_ini_param(oal_void)
{
    ...
    if (!uc_flag) {
        ...
        if (memcpy_s(&g_host_speed_freq_level, OAL_SIZEOF(g_host_speed_freq_level), &ast_host_speed_freq_level_tmp,
            OAL_SIZEOF(g_host_speed_freq_level)) != EOK) {
            OAM_ERROR_LOG0(0, OAM_SF_ANY, "{hwifi_config_host_global_ini_param::memcpy_s fail!}\r\n");
        }

        if (memcpy_s(&g_device_speed_freq_level, OAL_SIZEOF(g_device_speed_freq_level),
            &ast_device_speed_freq_level_tmp, OAL_SIZEOF(g_device_speed_freq_level)) != EOK) {
            OAM_ERROR_LOG0(0, OAM_SF_ANY, "{hwifi_config_host_global_ini_param::memcpy_s fail!!}\r\n");
        }
...
oal_int32 hwifi_cfg_init_line_params(wlan_cus_dy_cali_param_stru *puc_dyn_cali_param)
{
    ...
    l_ret += memcpy_s(puc_dyn_cali_param->al_bt_ppavdet_fit_params,
                      ...
                      &as_pro_line_params[CUS_DY_CALI_PARAMS_NUM + 2],
                      OAL_SIZEOF(puc_dyn_cali_param->al_bt_ppavdet_fit_params));
    return l_ret;
}
...
OAL_STATIC oal_uint32 hwifi_cfg_init_cus_dyn_cali(wlan_cus_dy_cali_param_stru *puc_dyn_cali_param)
{
    ...
    if (band_5g_enabled) {
        puc_dyn_cali_param->aus_dyn_cali_dscr_interval[WLAN_BAND_5G] =
           (oal_uint16)(((oal_uint32)l_val & 0xFFFF0000) >> 16);
    }
...
OAL_STATIC oal_int32 wal_finish_spe_td(oal_int32 l_port_num, oal_netbuf_stru *pst_buf, oal_uint32 ul_flags)
{
    ...
    if ((OAL_UNLIKELY(pst_net_dev != NULL)) && (OAL_UNLIKELY(pst_buf != NULL))) {
...
oal_int32 wal_vendor_config_filter_cmd(wal_wifi_priv_cmd_stru *pst_priv_cmd, oal_int8 *pc_command)
{
    ...
    if (l_ret != OAL_SUCC) {
        ...
        at least need [%d]", (CMD_FILTER_SWITCH_LEN + 2));
        oal_free(pc_command);
        return -OAL_EFAIL;
    }
...
,
                   ...
                   pst_oam_user_stat->ul_rx_mpdu_num, 0, 20,
...
,                  pst_hmac_user_tmp->uc_cur_per,
                   pst_hmac_user_tmp->uc_bestrate_per, 0
#endif
);
...
#ifdef _PRE_WLAN_FEATURE_PROXYSTA
    else if (strcmp("msta", ac_mode) == 0) {
        en_mode = WLAN_VAP_MODE_BSS_STA;
        en_psta_mode = PSTA_MODE_MSTA;
        if (wal_get_cmd_one_arg(pc_param + ul_off_set, ac_repid_str, OAL_SIZEOF(ac_repid_str), &ul_off_set) ==
            OAL_SUCC) {
            uc_rep_id = (oal_uint8)oal_atoi(ac_repid_str);
        }
    } else if (strcmp("vsta", ac_mode) == 0) {
        en_mode = WLAN_VAP_MODE_BSS_STA;
 ...
 */
    ...
    ***************************************************************************/
    ...
    ((mac_cfg_add_vap_param_stru *)st_write_msg.auc_value)->uc_rep_id =
        uc_rep_id >= WLAN_PROXY_STA_MAX_REP ? 0 : uc_rep_id;
#endif
#ifdef _PRE_WLAN_FEATURE_P2P
 ...
 */
    ul_ret = wal_get_cmd_one_arg(pc_param, ac_name, OAL_SIZEOF(ac_name), &ul_off_set);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_green_ap_en::wal_get_cmd_one_arg return err_code[%d]}", ul_ret);
        return ul_ret;
    }
...
OAL_STATIC oal_uint32 wal_hipriv_dfs_radartool(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    if (OAL_UNLIKELY(OAL_STRLEN(pc_param) >= WAL_MSG_WRITE_MAX_LEN)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_dfs_radartool:pc_param overlength is %d}", OAL_STRLEN(pc_param));
    ...
    ***************************************************************************/
    if (memcpy_s(st_write_msg.auc_value, OAL_SIZEOF(st_write_msg.auc_value), pc_param, OAL_STRLEN(pc_param)) != EOK) {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "wal_hipriv_dfs_radartool::memcpy fail!");
        return OAL_FAIL;
    }
...
oal_int32 wal_ioctl_set_country_code(oal_net_device_stru *pst_net_dev, oal_net_dev_ioctl_data_stru *pst_ioctl_data)
{
    ...
    if (memcpy_s(auc_country_code, OAL_SIZEOF(auc_country_code),
        pst_ioctl_data->pri_data.country_code.auc_country_code, 3) != EOK) {
...
OAL_STATIC oal_uint32 wal_hipriv_auto_cali(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    if (memcpy_s(st_write_msg.auc_value, OAL_SIZEOF(st_write_msg.auc_value), pc_param, OAL_STRLEN(pc_param)) != EOK) {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "{wal_hipriv_auto_cali:: memcpy fail}");
        return OAL_FAIL;
    }
    st_write_msg.auc_value[OAL_STRLEN(pc_param)] = '\0';
...
OAL_STATIC oal_uint32 wal_hipriv_set_cali_vref(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    ul_ret = wal_get_cmd_one_arg(pc_param, ac_arg, OAL_SIZEOF(ac_arg), &ul_off_set);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_set_cali_ref::wal_get_cmd_one_arg return err_code %d!}", ul_ret);
        return ul_ret;
    }
    ...
    ul_ret = wal_get_cmd_one_arg(pc_param, ac_arg, OAL_SIZEOF(ac_arg), &ul_off_set);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "wal_hipriv_set_cali_ref:wal_get_cmd_one_arg err_code %d", ul_ret);
        return ul_ret;
    }
