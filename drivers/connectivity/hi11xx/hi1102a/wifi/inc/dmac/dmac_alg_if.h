...
typedef oal_void (*p_alg_cfg_dual_antenna_state_notify_func)(
    mac_device_stru *pst_device, oal_uint32 ul_status);
#endif
...
typedef oal_uint32 (*p_alg_tx_schedule_stat_event_notify_func)(
    oal_uint8 uc_device_id, oal_uint8 uc_vap_id, oal_uint8 (*ppuc_traffic_num)[ALG_TXRX_DATA_MAXNUM]);
#endif
...
typedef oal_uint32 (*p_alg_flowctl_backp_notify_func)(
    mac_vap_stru *pst_vap, oal_uint16 us_total_mpdu_num, oal_uint16 *pus_total_mpdu_num);
#endif
...
#ifdef _PRE_WLAN_FEATURE_SMARTANT
typedef oal_uint32 (*p_alg_get_ant_info_notify_func)(
    mac_vap_stru *pst_vap, oal_uint8 *puc_param, oal_uint32 *pul_param1, oal_uint32 *pul_param2,
    oal_uint32 *pul_param3, oal_uint32 *pul_param4, oal_uint32 *pul_param5);
...
#ifdef _PRE_WLAN_FEATURE_EDCA_MULTI_USER_MULTI_AC
extern oal_uint32 dmac_alg_register_tx_schedule_stat_event_notify_func(
    p_alg_tx_schedule_stat_event_notify_func p_func);
...
extern oal_uint32 dmac_alg_flowctl_backp(mac_vap_stru *pst_mac_vap, oal_uint16 us_assoc_id, oal_uint8 uc_tidno,
                                         oal_uint8 uc_is_stop);
#endif

#ifdef _PRE_WLAN_FEATURE_NBFH
extern oal_uint32 dmac_alg_register_nbfh_start_notify_func_ram(
    dmac_alg_nbfh_start_notify_enum_uint8 en_notify_sub_type, p_alg_nbfh_start_notify_func p_func);
...
extern oal_uint32 dmac_alg_register_nbfh_stop_notify_func_ram(
    dmac_alg_nbfh_stop_notify_enum_uint8 en_notify_sub_type, p_alg_nbfh_stop_notify_func p_func);
...
extern oal_uint32 dmac_alg_register_nbfh_sync_notify_func_ram(
    dmac_alg_nbfh_sync_notify_enum_uint8 en_notify_sub_type, p_alg_nbfh_sync_notify_func p_func);
