...
OAL_STATIC OAL_INLINE oal_void mac_set_acs_switch(mac_device_stru *pst_mac_device,
...
OAL_STATIC OAL_INLINE oal_void mac_dfs_set_offchan_cac_enable(mac_device_stru *pst_mac_device,
