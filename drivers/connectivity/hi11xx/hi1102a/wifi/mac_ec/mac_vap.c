...
oal_void mac_vap_init_mib_11ac(mac_vap_stru *pst_mac_vap)
{
    ...
    pst_mib_info->st_wlan_mib_vht_sta_config.ul_dot11VHTMaxRxAMPDUFactor = 7;
...
oal_void mac_vap_init_legacy_rates(mac_vap_stru *pst_vap, mac_data_rate_stru *pst_rates)
{
    ...
    for (uc_rate_index = 0; uc_rate_index < uc_rates_num; uc_rate_index++) {
        ...
        /* Basic Rates */
        if ((puc_orig_rate->uc_mbps == 6) || (puc_orig_rate->uc_mbps == 12) ||
            ...
            uc_curr_rate_index++;
        } else if ((puc_orig_rate->uc_mbps == 9) || (puc_orig_rate->uc_mbps == 18) ||
                   (puc_orig_rate->uc_mbps == 36) || (puc_orig_rate->uc_mbps == 48) ||
    ...
    if ((pst_vap->en_vap_mode == WLAN_VAP_MODE_BSS_STA) ||
        ...
        if (pst_vap->en_vap_mode == WLAN_VAP_MODE_BSS_STA) {
            ...
            switch (pst_mac_device->en_protocol_cap) {
                ...
                default:
                    OAM_WARNING_LOG1(pst_vap->uc_vap_id, OAM_SF_CFG, "{mac_vap_init::en_protocol_cap[%d] is not \
            ...
            switch (pst_mac_device->en_bandwidth_cap) {
                ...
                default:
                    OAM_WARNING_LOG1(pst_vap->uc_vap_id, OAM_SF_CFG, "mac_vap_init:en_bandwidth_cap[%d] is not \
