...
STATIC ssize_t show_coeff_dump(struct kobject *kobj, struct kobj_attribute *attr, int8 *buf)
{
    ...
    return snprintf_s(buf, PAGE_SIZE, PAGE_SIZE - 1, "dcxo coeff list:                \n"
                      ...
                      "dcxo_tcxo_flag = %d             \n"
                      "check_data     = 0x%x           \n",
                      pst_dl_para->coeff.para[COEFF_A0], pst_dl_para->coeff.para[COEFF_A0],
                      pst_dl_para->coeff.para[COEFF_A1], pst_dl_para->coeff.para[COEFF_A1],
                      pst_dl_para->coeff.para[COEFF_A2], pst_dl_para->coeff.para[COEFF_A2],
                      pst_dl_para->coeff.para[COEFF_A3], pst_dl_para->coeff.para[COEFF_A3],
                      pst_dl_para->coeff.para[COEFF_T0], pst_dl_para->coeff.para[COEFF_T0],
