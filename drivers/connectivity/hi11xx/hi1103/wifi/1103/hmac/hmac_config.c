...
OAL_STATIC oal_void hmac_config_connet_ftmode_set(hmac_vap_stru *hmac_vap,
    mac_conn_security_stru *conn_sec)
{
    ...
    if (hmac_vap->bit_11r_enable == OAL_TRUE) {
        akm_suite = OAL_NTOH_32(conn_sec->st_crypto.aul_akm_suite[0]);
...
oal_uint32  hmac_config_connect_etc(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param)
{
    ...
    hmac_config_connet_ftmode_set(pst_hmac_vap, &st_conn_sec);
