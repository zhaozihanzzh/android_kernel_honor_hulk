...
struct loadswitch_ops hi6526_lvc_ops = {
...
struct loadswitch_ops hi6526_sc_ops = {
	.ls_init = hi6526_dummy_fun_1,
	.ls_exit = hi6526_switch_to_buck_mode,
...
struct batinfo_ops hi6526_batinfo_ops = {
...
static void hi6526_fcp_scp_ops_register(void)
{
	...
	if (hi6526_is_support_scp() == 0) {
		 ...
		 * ret[5]: wireless sc ops reg
		 * ret[6]: wireless sc batinfo reg
		 * ret[7]: wireless chsw ops reg
		 */
		ret[0] = 0;
...
MODULE_AUTHOR("Shunlong Yang <yangshunlong@huawei.com>");
