...
void slimbus_hi6403_param_init(const struct slimbus_device_info *dev)
{
	uint32_t track;
...
int32_t slimbus_hi6403_param_set(struct slimbus_device_info *dev,
...
void slimbus_hi6403_param_update(const struct slimbus_device_info *dev,
 ...
 * return 0, if success
 */
int32_t slimbus_hi6403_create_device(struct slimbus_device_info **device)
{
...
void slimbus_hi6403_get_st_params(struct slimbus_sound_trigger_params *params)
{
	if (params != NULL) {
