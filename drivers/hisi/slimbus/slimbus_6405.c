 ...
 * return 0, if success
 */
int32_t slimbus_hi6405_create_device(struct slimbus_device_info **device)
{
...
void slimbus_hi6405_param_init(const struct slimbus_device_info *dev)
{
	uint32_t track;
...
int32_t slimbus_hi6405_param_set(struct slimbus_device_info *dev,
...
void slimbus_hi6405_param_update(const struct slimbus_device_info *dev,
...
int32_t slimbus_hi6405_check_scenes(uint32_t track, uint32_t scenes, bool track_enable)
{
	uint32_t i;
	int32_t ret = 0;
...
int32_t slimbus_hi6405_select_scenes(struct slimbus_device_info *dev, uint32_t track,
...
void slimbus_hi6405_get_st_params(struct slimbus_sound_trigger_params *params)
{
	if (params != NULL) {
...
int32_t slimbus_hi6405_track_soundtrigger_activate(uint32_t track, bool slimbus_dynamic_freq_enable,
...
int32_t slimbus_hi6405_track_soundtrigger_deactivate(uint32_t track)
{
	int32_t ret;
	struct slimbus_sound_trigger_params st_params;
...
struct slimbus_track_config *slimbus_hi6405_get_track_config_table(void)
{
