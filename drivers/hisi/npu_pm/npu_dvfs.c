...
#ifdef CONFIG_NPU_PM_SHARE_PERI_BUCK
#define HISI_NPU_VOTE_PERI_VOLT_TIMEOUT		5000 /* us */
static int hisi_npu_vote_peri_voltage(int tar_pid)
{
	int ret = 0;
	int vote_timeout = HISI_NPU_VOTE_PERI_VOLT_TIMEOUT;
...
#ifdef CONFIG_NPU_PM_SHARE_PERI_BUCK
static int hisi_npu_set_peri_voltage(const struct hisi_npu_module_profile *module_profile,
				     int tar_pid)
{
	int ret = 0;
...
{
#ifdef CONFIG_NPU_PM_SHARE_PERI_BUCK
	return hisi_npu_set_peri_voltage(module_profile, tar_pid);
#else
