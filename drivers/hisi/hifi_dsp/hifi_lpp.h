...
#define HIFI_MUSIC_DATA_SIZE                (0x0)
#define PCM_PLAY_BUFF_SIZE                  (0x132000)
#else
...
typedef enum HIFI_MSG_ID_ {
	...
	ID_HIFI_AP_SMARTPA_DFT_PROCESS_ERROR= 0xDF11,
	ID_HIFI_AP_SMARTPA_DFT_F0_ERROR     = 0xDF12,
	ID_HIFI_AP_SMARTPA_DFT_RESISTANCE_ERROR      = 0xDF13,
	ID_HIFI_AP_SMARTPA_DFT_OVERHEAT_ERROR        = 0xDF14,
