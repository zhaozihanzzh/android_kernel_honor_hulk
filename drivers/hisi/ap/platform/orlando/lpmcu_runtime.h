...
#define FCM_CNT_ADDR(n) WORD_REF(RUNTIME_FCM_CNT_ADDR(n))
...
#define RUNTIME_GPU_DEBUG_ADDR (RUNTIME_VAR_BASE + 0x51)
...
#define RUNTIME_PERIL_VAR_END (RUNTIME_CPU_LOWTEMP_VOLT_BIAS_ADDR(2))
...
#define ASP_CLK_STATE (HALFWORD_REF(RUNTIME_ASP_CLK_STATE_ADDR))
#define RUNTIME_ASP_CLK_STATE2_ADDR (RUNTIME_SHARE_MEM_END_ADDR + 0x02E)
#define ASP_CLK_STATE2 (HALFWORD_REF(RUNTIME_ASP_CLK_STATE2_ADDR))
...
#define RUNTIME_SPACE_ADDR_END (RUNTIME_CPU_MEMORY_STEP2_VOLT_BIAS_ADDR)
