...
#define SOC_UFS_Sysctrl_UFS_MID_ADDR(base) ((base) + (0x0F8))
...
#endif
#define SOC_UFS_Sysctrl_DEBUG_MONITOR_UME_HH_sysctrl_dbg_monitorup_hh_START (0)
#define SOC_UFS_Sysctrl_DEBUG_MONITOR_UME_HH_sysctrl_dbg_monitorup_hh_END (15)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_UFS_Sysctrl_CRG_UFS_CFG_clkdivmasken_START (16)
#define SOC_UFS_Sysctrl_CRG_UFS_CFG_clkdivmasken_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#endif
#define SOC_UFS_Sysctrl_CRG_UFS_CFG1_clkdivmasken_START (16)
#define SOC_UFS_Sysctrl_CRG_UFS_CFG1_clkdivmasken_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
typedef union
{
    ...
    struct
    {
        unsigned int ufs_peri_subsys_wrap_mid : 6;
        unsigned int reserved : 26;
    } reg;
} SOC_UFS_Sysctrl_UFS_MID_UNION;
#endif
#define SOC_UFS_Sysctrl_UFS_MID_ufs_peri_subsys_wrap_mid_START (0)
#define SOC_UFS_Sysctrl_UFS_MID_ufs_peri_subsys_wrap_mid_END (5)
#ifdef __cplusplus
    #if __cplusplus
        }
    #endif
