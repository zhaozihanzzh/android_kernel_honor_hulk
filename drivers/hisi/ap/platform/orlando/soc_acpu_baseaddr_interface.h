...
#define SOC_ACPU_CORE_CRG_B_BASE_ADDR (0xFFF39000)
#define SOC_ACPU_CORE_CRG_L_L3_BASE_ADDR (0xFFF38000)
...
#define SOC_ACPU_IOMCU_DTCM_BASE_ADDR (0xFFC00000)
#define SOC_ACPU_IOMCU_ITCM_BASE_ADDR (0xFFB00000)
...
#define SOC_ACPU_I3C4_BASE_ADDR (0xFDF0E000)
...
#define SOC_ACPU_EMMC_PHY_CTRL_BASE_ADDR (0xFC187000)
#define SOC_ACPU_MMC1_SYS_CTRL_BASE_ADDR (0xFC186000)
#define SOC_ACPU_EMMC_GPIO1_BASE_ADDR (0xFC185000)
#define SOC_ACPU_EMMC_GPIO0_BASE_ADDR (0xFC184000)
#define SOC_ACPU_SDIO0_BASE_ADDR (0xFC183000)
#define SOC_ACPU_IOC_MMC1_BASE_ADDR (0xFC182000)
#define SOC_ACPU_EMMC_CFG_BASE_ADDR (0xF4000000)
...
#define SOC_ACPU_FCM_NOC_Service_Target_BASE_ADDR (0xEA200000)
...
#define SOC_ACPU_GMP_BASE_ADDR (0xE86A0000)
...
#define SOC_ACPU_SMMU_BASE_ADDR (0xE8320000)
#define SOC_ACPU_ORB_BASE_ADDR (0xE830C000)
#define SOC_ACPU_CVDR_BASE_ADDR (0xE8306000)
#define SOC_ACPU_CMDLST_BASE_ADDR (0xE8305000)
#define SOC_ACPU_TOP_BASE_ADDR (0xE8304000)
#define SOC_ACPU_JPGENC_BASE_ADDR (0xE8300000)
...
#define SOC_ACPU_l2buf_cfg_BASE_ADDR (0xE5F80000)
#define SOC_ACPU_npu_smmu_cfg_BASE_ADDR (0xE5F00000)
#define SOC_ACPU_sysdma_cfg_BASE_ADDR (0xE5E80000)
...
#define SOC_ACPU_aic_bus_service_target_BASE_ADDR (0xE4D10000)
#define SOC_ACPU_npu_cpu_bus_service_target_BASE_ADDR (0xE4D00000)
...
#define SOC_ACPU_sysctrl_BASE_ADDR (0xE4030000)
...
#define SOC_ACPU_DSP0_L2MEM_BASE_ADDR (0xE36C0000)
