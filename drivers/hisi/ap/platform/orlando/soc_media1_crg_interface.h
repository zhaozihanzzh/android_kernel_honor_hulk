...
#endif
#define SOC_MEDIA1_CRG_CLKDIV1_sel_jpg_func_pll_START (6)
#define SOC_MEDIA1_CRG_CLKDIV1_sel_jpg_func_pll_END (9)
...
#define SOC_MEDIA1_CRG_PERI_STAT2_sw_ack_clk_jpg_func_sw_START (4)
#define SOC_MEDIA1_CRG_PERI_STAT2_sw_ack_clk_jpg_func_sw_END (7)
