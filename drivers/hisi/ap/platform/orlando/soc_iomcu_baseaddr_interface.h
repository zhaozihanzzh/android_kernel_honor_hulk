...
#define SOC_IOMCU_CORE_CRG_B_BASE_ADDR (0x5FF39000)
#define SOC_IOMCU_CORE_CRG_L_L3_BASE_ADDR (0x5FF38000)
...
#define SOC_IOMCU_I3C4_BASE_ADDR (0x5DF0E000)
...
#define SOC_IOMCU_EMMC_PHY_CTRL_BASE_ADDR (0x5C187000)
#define SOC_IOMCU_MMC1_SYS_CTRL_BASE_ADDR (0x5C186000)
#define SOC_IOMCU_EMMC_GPIO1_BASE_ADDR (0x5C185000)
#define SOC_IOMCU_EMMC_GPIO0_BASE_ADDR (0x5C184000)
#define SOC_IOMCU_SDIO0_BASE_ADDR (0x5C183000)
#define SOC_IOMCU_IOC_MMC1_BASE_ADDR (0x5C182000)
#define SOC_IOMCU_EMMC_CFG_BASE_ADDR (0x54000000)
...
#define SOC_IOMCU_GIC600_BASE_ADDR (0x4A000000)
...
#define SOC_IOMCU_GMP_BASE_ADDR (0x486A0000)
...
#define SOC_IOMCU_MCTL_MUTEX_BASE_ADDR (0x48610800)
...
#define SOC_IOMCU_SMMUv500_CFG_BASE_ADDR (0x485F0000)
#define SOC_IOMCU_ISP_R8_PERI_BASE_BASE_ADDR (0x485EE000)
#define SOC_IOMCU_ISP_TCMDMA_BASE_ADDR (0x485E4000)
#define SOC_IOMCU_ISP_SUB_CTRL_BASE_ADDR (0x485E3000)
#define SOC_IOMCU_ISP_IPC_BASE_ADDR (0x485E2000)
#define SOC_IOMCU_ISP_TIMER_BASE_ADDR (0x485E1000)
#define SOC_IOMCU_ISP_WDT_BASE_ADDR (0x485E0000)
...
#define SOC_IOMCU_SMMU_BASE_ADDR (0x48320000)
#define SOC_IOMCU_ORB_BASE_ADDR (0x4830C000)
#define SOC_IOMCU_CVDR_BASE_ADDR (0x48306000)
#define SOC_IOMCU_CMDLST_BASE_ADDR (0x48305000)
#define SOC_IOMCU_TOP_BASE_ADDR (0x48304000)
#define SOC_IOMCU_JPGENC_BASE_ADDR (0x48300000)
...
#define SOC_IOMCU_CODEC_BASE_ADDR (0x48052000)
...
#define SOC_IOMCU_npu_smmu_cfg_BASE_ADDR (0x45F00000)
...
#define SOC_IOMCU_aic_subsys_cfg_BASE_ADDR (0x45000000)
#define SOC_IOMCU_npu_bus_service_target_BASE_ADDR (0x44D30000)
#define SOC_IOMCU_aic_bus_service_target_BASE_ADDR (0x44D10000)
#define SOC_IOMCU_npu_cpu_bus_service_target_BASE_ADDR (0x44D00000)
...
#define SOC_IOMCU_sysctrl_BASE_ADDR (0x44030000)
