...
#define DDR_RESERVED_BASE_AP DDR_FP_IMAGE_END_AP
#define DDR_RESERVED_SIZE (0x7F000)
#define DDR_RESERVED_END_AP (DDR_RESERVED_BASE_AP + DDR_RESERVED_SIZE)
#define DDR_F2L_CONFIG_ADDR_AP DDR_RESERVED_END_AP
#define DDR_F2L_CONFIG_SIZE (0x1000)
#define DDR_F2L_END_AP (DDR_F2L_CONFIG_ADDR_AP + DDR_F2L_CONFIG_SIZE)
#define DDR_RESERVED_USED_END DDR_F2L_END_AP
