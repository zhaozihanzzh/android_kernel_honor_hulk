...
#endif
#define PERI_AVS_PARA_BASE (LPMCU_GEN_MNTN_BASE + LPMCU_GEN_MNTN_SIZE)
#define PERI_AVS_PARA_SIZE (0x200)
#define LPMCU_MODEM_SEC_BASE (PERI_AVS_PARA_BASE + PERI_AVS_PARA_SIZE)
...
#define LPMCU_TELE_MNTN_SEC_SIZE (0xC00)
  ...
  #define LPMCU_TELE_MNTN_DATA_TICKMARK_SIZE (0x150)
    ...
    #define LPMCU_TELE_MNTN_BUF_SIZE (0x800)
...
#define LPMCU_DDR_DATA_SEC_SIZE (0x4400)
    ...
    #define DDR_TRAINNING_SIZE (0x2c00)
    #define DDR_PROFILE_BASE (DDR_TRAINNING_BASE + DDR_TRAINNING_SIZE)
    #define DDR_PROFILE_SIZE (0x800)
...
#define SYS_CODE_SEC_RESERVED_SIZE (0x100)
#define SYS_CODE_SEC_SIZE (0x17140-SYS_CODE_SEC_RESERVED_SIZE)
#define SYS_BSS_SEC_BASE (SYS_CODE_SEC_BASE + SYS_CODE_SEC_SIZE + SYS_CODE_SEC_RESERVED_SIZE)
#define SYS_BSS_SEC_RESERVED_SIZE (0x100)
#define SYS_BSS_SEC_SIZE (0x38C0-SYS_BSS_SEC_RESERVED_SIZE)
...
#define LPMCU_DDR_MNTN_SIZE (0x1400)
    ...
    #define DDRC_SAVE_TMP_SIZE (0x300)
...
#define GPU_BASE_PROFILE_SIZE (0x250)
