/* MD5: 90f4693ea9a0f2fd3ff20a921e659cc2*/
...
#ifndef PLATFORM
#define PLATFORM orlando 
#endif 

#ifndef PLATFORM_HISI_BALONG
#define PLATFORM_HISI_BALONG orlando 
#endif 
...
#define HW_VERSION_STUB 0x35F5FC02 
#endif 
...
#define CPU_VIEW_LLRAM_SIZE 0x0 
#endif 
...
#define DFC_LLRAM_SIZE ((MAILBOX_LLRAM_SIZE) + (CPU_VIEW_LLRAM_SIZE) + (SOCP_LLRAM_SIZE) + (LL2_LLRAM_SIZE)) 
#endif 
...
#ifndef CONFIG_PMU_AVOID_WIFI_CLK
#define CONFIG_PMU_AVOID_WIFI_CLK 
#endif 
...
#define DDR_MCORE_SIZE 0x8100000 
#endif 

#ifndef DDR_HARQ_UP_SIZE
#define DDR_HARQ_UP_SIZE 0x43800 
#endif 

#ifndef DDR_TLPHY_IMAGE_SIZE
#define DDR_TLPHY_IMAGE_SIZE 0x780000 
#endif 
...
#define DDR_LPHY_SDR_SIZE 0x800000 
#endif 
...
#define DDR_MCORE_UNCACHE_SIZE 0x1E00000 
#endif 
...
#define SHM_SIZE_SEC_RESERVED (0x7800) 
#endif 
...
#define DDR_SHA_NV_SIZE 0x6F8000 
#endif 
...
#define NV_COMM_BIN_FILE_MAX_SIZE 0x7DFC00 
#endif 
