...
CFG_DFC_LLRAM_SIZE             := ((MAILBOX_LLRAM_SIZE) + (CPU_VIEW_LLRAM_SIZE) + (SOCP_LLRAM_SIZE) + (LL2_LLRAM_SIZE))
...
CFG_CONFIG_PMU_AVOID_WIFI_CLK := YES
CFG_CONFIG_PHONE_DCXO_AP := YES
CFG_CONFIG_OS_INCLUDE_LP:=NO
...
CFG_DDR_MCORE_SIZE        := 0x8100000
CFG_DDR_HARQ_UP_SIZE      := 0x43800
CFG_DDR_TLPHY_IMAGE_SIZE  := 0x780000
CFG_DDR_GU_SIZE           := 0x40000
CFG_DDR_MCORE_DTS_SIZE    := 0x80000
CFG_DDR_CBBE_IMAGE_SIZE   := 0x000000
CFG_DDR_LPHY_SDR_SIZE     := 0x800000
...
CFG_DDR_MCORE_UNCACHE_SIZE              := 0x1E00000
...
CFG_SHM_SIZE_SEC_RESERVED       :=(0x7800)
...
CFG_NV_COMM_BIN_FILE_MAX_SIZE       := 0x7DFC00
