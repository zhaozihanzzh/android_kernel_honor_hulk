...
/* efuse r&w func id */
#define EFUSE_FN_WR_MODEM_HUK_VALUE       (0xc5000016)
#define EFUSE_FN_RD_MODEM_HUK_VALUE       (0xc5000017)
#define EFUSE_FN_RD_DIEID_VALUE           (0xc5000018)
#define EFUSE_FN_WR_DIEID_VALUE           (0xc5000019)
#define EFUSE_FN_RD_CHIPID_VALUE          (0xc500001A)
#define EFUSE_FN_WR_CHIPID_VALUE          (0xc500001B)
#define EFUSE_FN_RD_AUTH_KEY_VALUE        (0xc500001C)
#define EFUSE_FN_WR_AUTH_KEY_VALUE        (0xc500001D)

/* enable and disable debug mode */
#define EFUSE_FN_ENABLE_DEBUG             (0xc500001E)
#define EFUSE_FN_DISABLE_DEBUG            (0xc500001F)
...
s32 hisi_efuse_read_value(u32 *buf, u32 buf_size, u32 func_id)
{
	s32 ret;
	u32 i;
	unsigned char temp_buf[EFUSE_BUFFER_MAX_BYTES] = {0};
	unsigned char *p_src;
	unsigned char *p_dst;
	...
	p_dst = (unsigned char *)buf;
	ret = g_efusec.atf_fn(func_id, (u64)g_efusec.paddr,
		(u64)buf_size, EFUSE_TIMEOUT_1000MS);
	if (ret != OK) {
		goto exit;
	}
