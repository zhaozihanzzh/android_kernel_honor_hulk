		...
		struct device_attribute *attr, const char *buf, size_t count)
{
	...
	thp_set_status(THP_STAUTS_WINDOW_UPDATE,
		!thp_get_status(THP_STAUTS_WINDOW_UPDATE));
		...
		struct device_attribute *attr, const char *buf, size_t count)
{
	...
	thp_set_status(THP_STAUTS_TOUCH_SCENE,
		!thp_get_status(THP_STAUTS_TOUCH_SCENE));
